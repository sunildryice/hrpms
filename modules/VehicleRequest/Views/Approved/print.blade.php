            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="print-code fs-7 fw-bold mb-2">
                        Vehicle Request No: {!! $vehicleRequest->getVehicleRequestNumber() !!}
                    </div>
        ...
        <div class="print-body border-top">
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-lg-3">
                        <div class="d-flex align-items-start  h-100">
                            <label for="" class="m-0 text-end flex-grow-1 fw-bold">Extra Travel from DHQ (in
                                KM) </label>
                        </div>
                    </div>
                    <div class="col-lg-9">
                ...
                <div class="col-lg-4">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            ...
                            {{ $vehicleRequest->approver->employee->latestTenure->getDesignationName() }}
                        </li>
                        <li>
