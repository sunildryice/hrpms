...
@section('title', 'Review Recommended Purchase Request')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function () {
            $('#navbarVerticalMenu').find('#review-recommended-purchase-requests-menu').addClass('active');
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
                ...
                plugins: {
                    ...
                    excluded: new FormValidation.plugins.Excluded({
                        excluded: function (field, ele, eles) {
                            ...
                            return (field === 'log_remarks' && statusId === 0) || (field === 'status_id' && statusId !== 0);
                        },
                    }),
            ...
            function calculateBalanceBudget($element)
            {
                ...
                $($element).closest('tr').find('[id="estimated_balance_budget"]').val(estimatedBalanceAmount.toFixed(2));
            }
        });
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('review.recommended.purchase.requests.index') }}"
            ...
            <section class="registration">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <form action="{{ route('review.recommended.purchase.requests.store', $purchaseRequest->id) }}"
                              id="purchaseRequestReviewForm" method="post"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="border-top pt-4">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control  @if($errors->has('status_id')) is-invalid @endif"
                                                            data-width="100%">
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                    ...
                                    <a href="{!! route('review.purchase.requests.index') !!}"
