...
@section('title', 'Edit Construction Track Settlement')
...
@section('page_js')
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function(e) {
            ...
            $(document).on('click', '.open-settlement-modal-form', function (e) {
                e.preventDefault();
                $('#openModal').find('.modal-content').html('');
                $('#openModal').modal('show').find('.modal-content').load($(this).attr('href'), function () {
                    const form = document.getElementById('constructionInstallForm');
                    ...
                    const fv = FormValidation.formValidation(form, {
                        fields: {
                            advance_release_date: {
                                validators: {
                                    notEmpty: {
                                        message: 'Advance Release Date is required',
                                    },
                                    date: {
                                        format: 'YYYY-MM-DD',
                        ...
                        var successCallback = function(response) {
                            ...
                            constructionTransactionTable.ajax.reload();
                        }
                        ajaxSubmit($url, 'POST', data, successCallback);
                    });

                    $('#openModal').find('[name="advance_release_date"]').datepicker({
                        language: 'en-GB',
                        autoHide: true,
                        format: 'yyyy-mm-dd',
                        ...
                        fv.revalidateField('advance_release_date');
                    });
                });
            });
        ...
        var constructionTransactionTable = $('#constructionInstallmentTable').DataTable({
            processing: true,
            serverSide: true,
        ...
        $('#constructionInstallmentTable').on('click', '.delete-record', function(e) {
            e.preventDefault();
            $object = $(this);
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if ($errors->has('effective_date_to')) is-invalid @endif"
                                            type="text" readonly name="effective_date_to"
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="validationdd" class="m-0">Engineer Name</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="card">
                                        <div class="card-header fw-bold">
                                            <div style="display: flex; flex-direction: row; align-items: center; justify-content: space-between;">
                                                ...
                                                @if (auth()->user()->can('addInstallment', $construction))
                                                    <button data-toggle="modal" class="btn btn-primary btn-sm open-settlement-modal-form"
                                                        href="{{ route('construction.installment.create', $construction->id) }}"><i
                                                            class="bi-plus"></i> Add Transaction
                                                    </button>
                                                @endif
                                            </div>
                                        </div>
