                        ...
                        <ul class="m-0 list-unstyled">
                           ...
                           <!--  <li class="nav-item"><a href="#" class="nav-link text-decoration-none"><i
                            ...
                            <li class="nav-item"><a
                                            ...
                                            Asset Handover</a></li>
                            <li class="nav-item"><a href= "@if($authUser->can('update', $exitInterview)) {{route('exit.employee.interview.edit')}} @else {{route('exit.employee.interview.show')}} @endif" class="nav-link active text-decoration-none"><i
