            ...
            <section class="registration">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if($probationaryReviewIndicators->count() > 0)
                        ...
                        <form action="{!! route('approve.probation.review.request.store', $probationaryReview->id) !!}" method="post"
                            ...
                            <div class="row mb-3 col-6">
                                ...
                                <div class="mt-2">
                                    <select name="status_id" class="select2 form-control @if($errors->has('status_id')) is-invalid @endif" data-width="100%">
