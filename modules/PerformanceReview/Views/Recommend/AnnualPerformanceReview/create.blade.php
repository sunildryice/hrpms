...
@section('title', 'Recommend Annual Performance Review')
...
@section('page-content')
                            ...
                            <tr>
                                ...
                                @foreach ($groupFQuestions as $question)
                                    <td style="text-align: center">
                                        <input disabled type="hidden" name="{{ 'question_' . $question->id }}"
    ...
    <section>
        <div class="card">
            ...
            <form action="{{ route('performance.recommend.store') }}" id="performanceReviewProcessForm" method="post"
                                ...
                                <div class="w-100">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <label class="mb-0 form-label">{{ $log->createdBy->getFullName() }}</label>
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-lg-9">
                                <select name="status_id" id="status_id" class="select2 form-control" data-width="100%">
                                    ...
                                    <option value="{{ config('constant.RECOMMENDED_STATUS') }}"
                                        {{ old('status_id') == config('constant.RECOMMENDED_STATUS') ? 'selected' : '' }}>
                                        Recommend</option>
                                    ...
                                    @foreach ($approvers as $approver)
                                        @if ($loop->first)
                                            <option value="{{ $approver->id }}"
                                                {{ old('receiver_id') == $approver->id ? 'selected' : (empty(old('receiver_id')) ? 'selected' : '') }}>
                ...
                <div class="gap-2 border-0 card-footer justify-content-end d-flex">
                    ...
                    <a href="{!! route('performance.recommend.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                </div>
            </form>
        </div>
    </section>
