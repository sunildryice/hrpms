...
@section('title', 'Approved Maintenance Request')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function () {
            $('#navbarVerticalMenu').find('#approved-maintenance-requests-menu').addClass('active');
        });
    </script>
@endsection
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('approved.maintenance.requests.index') }}"
