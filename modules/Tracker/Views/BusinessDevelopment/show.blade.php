                ...
                <div class="card">
                    <div class="card-header fw-bold">
                        <div style="display: flex; flex-direction: row; justify-content: space-between;">
                            ...
                            @if($businessDevelopment->created_by == auth()->id())
                                <a href="{{ route('business-development.edit', $businessDevelopment->id) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <p>
                                    @if ($businessDevelopment->url)
                                        <a href="{{$businessDevelopment->url}}"
                                           target="_blank">{{$businessDevelopment->url}}</a>
                                    @else
                                        N/A
                                    @endif
                                </p>
                        ...
                        <div class="col-md-4">
                            ...
                            <p>
                                @if ($businessDevelopment->attachment)
                                    <a href="{{asset('storage/'.$businessDevelopment->attachment)}}" target="_blank"
