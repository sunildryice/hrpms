...
@section('title', 'Direct Dispatch Requests')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var oTable = $('#goodRequestTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('good.requests.direct.dispatch.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-2">
                <div class="brd-crms flex-grow-1">
                 ...
                 <div class="add-info justify-content-end">
                     <a href="{!! route('direct.dispatch.bulk.create') !!}" class="btn btn-primary btn-sm" rel="tooltip" title="Direct Dispatch Bulk">
