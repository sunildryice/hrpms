...
@section('title', 'Key-Goals Review Form')
@section('page_css')
...
@section('page-content')
    ...
    <section class="print-info bg-white p-3" id="print-info">
        <div class="print-title fw-bold mb-3 translate-middle text-center ">
            ...
            <div class="fs-8"> Key-Goals Review Form</div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table class="table border">
                        ...
                        <tbody>
                            @foreach ($currentKeyGoals as $key => $keygoal)
                                <tr>
                    ...
                    <table class="table border">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4" >C. Professional Development Plan</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <table class="table border mb-4">
                        <tbody>
                            <tr>
                                ...
                                <td>{{$performanceReview->logs->where('status_id', config('constant.SUBMITTED_STATUS'))->last()?->created_at?->toFormattedDateString()}}</td>
                            </tr>
                            <tr>
