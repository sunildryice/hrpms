<div class="modal-header bg-primary text-white">
    <h5 class="modal-title mb-0 fs-6" id="openModalLabel">Close
        {{ $advanceRequest->getAdvanceRequestNumber() }}</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form action="{!! route('close.advance.requests.store', $advanceRequest->id) !!}" method="post" enctype="multipart/form-data" id="closeForm" autocomplete="off">
