...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function () {
            $('#navbarVerticalMenu').find('#approve-exit-asset').addClass('active');
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                           <div class="table-responsive">
                                <table class="table table-responsive table-bordered" id="goodRequestAssets" style="width: 100%">
                                    <thead>
                                        <tr>
                    ...
                    <div class="card">
                        <div class="card-header fw-bold">
                            Exit Asset Handover Process
                        </div>
                        <form action="{{ route('approve.exit.handover.asset.store', $exitAssetHandover->id) }}"
                ...
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                @if($exitAssetHandover->status_id == '3')
                            ...
                            <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                ...
                                <a href="{!! route('approve.exit.handover.asset.index') !!}"
