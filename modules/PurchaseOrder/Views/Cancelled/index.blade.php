...
@section('title', 'Cancelled Purchase Orders')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#cancelled-purchase-orders-menu').addClass('active');

            var oTable = $('#purchaseOrderTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('cancelled.purchase.orders.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
