...
@section('title', 'Recommend Performance Review')
...
@section('page_js')
    <script type="text/javascript">
        $(function() {
            ...
            var oTable = $('#performanceRecommendTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('performance.recommend.index') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
            ...
            $('#performanceRecommendTable').on('click', '.delete-record', function(e) {
                e.preventDefault();
                $object = $(this);
        ...
        <div class="card" id="performance-review-table">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table" id="performanceRecommendTable">
                        <thead>
                            <tr>
                                <th>{{ __('label.sn') }}</th>
                                <th>Employee Name</th>
