...
@php
    $action = $employee->address->created_at
        ? route('employees.address.update', [$employee->id, $employee->address->id])
        : route('employees.address.store', $employee->id);

@endphp
<form class="needs-validation" action="{{ $action }}" method="POST" id="addressAddForm" autocomplete="off"
    enctype="multipart/form-data">
    <div class="card-body">
        {!! csrf_field() !!}
        <label for="validationprovince" class="mb-4 form-label text-primary fw-bold">Current Address</label>
        <div class="mb-2 row">
            <div class="col-lg-3">
            ...
            <div class="col-lg-9">
                <select id="validationprovince" data-width="100%"
                    class="select2 form-control @if ($errors->has('temporary_province_id')) is-invalid @endif"
        ...
        <div class="mb-2 row">
            ...
            <div class="col-lg-9">
                <select id="validationdistrict" data-width="100%"
                    class="select2 form-control @if ($errors->has('temporary_district_id')) is-invalid @endif"
        ...
        <div class="mb-2 row">
            ...
            <div class="col-lg-9">
                <select id="validationmunicipality" data-width="100%"
                    class="select2 form-control
                @if ($errors->has('temporary_local_level_id')) is-invalid @endif"
                    name="temporary_local_level_id">
        ...
        <div class="mb-2 row">
            ...
            <div class="col-lg-9">
                <input type="number" class="form-control @if ($errors->has('temporary_ward')) is-invalid @endif"
                    id="validationward" value="{{ old('temporary_ward') ?: $employee->address->temporary_ward }}"
                    name="temporary_ward" placeholder="Ward Number">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control @if ($errors->has('temporary_tole')) is-invalid @endif"
                    id="validationtole" value="{{ old('temporary_tole') ?: $employee->address->temporary_tole }}"
        ...
        <div class="mt-3 mb-3 row">
            <div class="col-lg-3">
                <div class="p-1 mb-2 d-flex align-items-center h-100">
                    <label for="validationprovince" class="form-label text-primary fw-bold">Permanent Address</label>
                </div>
            </div>
            <div class="col-lg-9">
                <div class="p-1 mb-2 d-flex align-items-center h-100">
                    <label for="validationcurrent" class="gap-2 d-flex align-items-center">
        ...
        <div class="currentchecked">
            <div class="mb-2 row">
                ...
                <div class="col-lg-9">
                    <select id="validationprovince2" data-width="100%"
                        class="select2 form-control @if ($errors->has('permanent_province_id')) is-invalid @endif"
            ...
            <div class="mb-2 row">
                ...
                <div class="col-lg-9">
                    <select id="validationdistrict2" data-width="100%"
                        class="select2 form-control @if ($errors->has('permanent_district_id')) is-invalid @endif"
            ...
            <div class="mb-2 row">
                <div class="col-lg-3">
                    <div class="d-flex align-items-start h-100">
                        <label for="validationmunicipality2" class="form-label required-label">Local Level
                            Government</label>
                    </div>
                </div>
                <div class="col-lg-9">
                    <select id="validationmunicipality2" data-width="100%"
                        class="select2 form-control @if ($errors->has('permanent_local_level_id')) is-invalid @endif"
                        ...
                        @foreach ($localLevels as $locallevel)
                            ...
                            <option value="{{ $locallevel->id }}"
                                {{ $locallevel->id == $l_selected ? 'selected' : '' }}>
                                {{ $locallevel->local_level_name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="mb-2 row">
                ...
                <div class="col-lg-9">
                    <input type="number" class="form-control @if ($errors->has('permanent_ward')) is-invalid @endif"
                        id="validationwardno2"
            ...
            <div class="mb-2 row">
                ...
                <div class="col-lg-9">
                    <input type="text" class="form-control @if ($errors->has('permanent_tole')) is-invalid @endif"
                        id="validationtole2"
                        value="{{ old('permanent_tole') ?: $employee->address->permanent_tole }}" placeholder="Tole"
                        name="permanent_tole">
                            ...
                            callback: {
                                ...
                                callback: function(value, validator, $field) {
                                    if ($('[name="validationcurrent"]').is(':checked')) {
                                        validator.updateStatus('permanent_province_id', validator
                                            .STATUS_VALID);
                                        return true;
                                    } else {
                                        return true;
                    ...
                    permanent_district_id: {
                        validators: {
                            ...
                            callback: {
                                ...
                                callback: function(value, validator, $field) {
                                    if ($('[name="validationcurrent"]').is(':checked')) {
                                        validator.updateStatus('permanent_district_id', validator
                                            .STATUS_VALID);
                                        return true;
                                    } else {
                                        return true;
                    ...
                    permanent_local_level_id: {
                        validators: {
                            ...
                            callback: {
                                ...
                                callback: function(value, validator, $field) {
                                    if ($('[name="validationcurrent"]').is(':checked')) {
                                        validator.updateStatus('permanent_local_level_id', validator
                                            .STATUS_VALID);
                                        return true;
                                    } else {
                                        return true;
                    ...
                    permanent_ward: {
                        validators: {
                            ...
                            callback: {
                                ...
                                callback: function(value, validator, $field) {
                                    if ($('[name="validationcurrent"]').is(':checked')) {
                                        validator.updateStatus('permanent_ward', validator
                                            .STATUS_VALID);
                                        return true;
                                    } else {
                                        return true;
                    ...
                    permanent_tole: {
                        validators: {
                            ...
                            callback: {
                                ...
                                callback: function(value, validator, $field) {
                                    if ($('[name="validationcurrent"]').is(':checked')) {
                                        validator.updateStatus('permanent_tole', validator
                                            .STATUS_VALID);
                                        return true;
                                    } else {
                                        return true;
            ...
            $('#addressAddForm').on('change', '[name="temporary_province_id"]', function(e) {
                ...
                if (provinceId) {
                    ...
                    var successCallback = function(response) {
                        ...
                        $($element).closest('form').find('[name="temporary_district_id"]').html(
                            htmlToReplace).trigger('change');
                        $($element).closest('form').find('[name="temporary_district_id"]').select2(
                            "destroy").select2();
                    }
                ...
                if (districtId) {
                    ...
                    var successCallback = function(response) {
                        ...
                        $($element).closest('form').find('[name="temporary_local_level_id"]').html(
                            htmlToReplace).trigger('change');
                        $($element).closest('form').find('[name="temporary_local_level_id"]').select2(
                            "destroy").select2();
                    }
                    var errorCallback = function(error) {
                        console.log(error);
                ...
                if (provinceId) {
                    ...
                    var successCallback = function(response) {
                        ...
                        $($element).closest('form').find('[name="permanent_district_id"]').html(
                            htmlToReplace).trigger('change');
                        $($element).closest('form').find('[name="permanent_district_id"]').select2(
                            'destroy').select2();
                    }
                    var errorCallback = function(error) {
                        console.log(error);
                ...
                if (districtId) {
                    ...
                    var successCallback = function(response) {
                        ...
                        $($element).closest('form').find('[name="permanent_local_level_id"]').html(
                            htmlToReplace).trigger('change');
                        $($element).closest('form').find('[name="permanent_local_level_id"]').select2(
                            'destroy').select2();
                    }
                    var errorCallback = function(error) {
                        console.log(error);
