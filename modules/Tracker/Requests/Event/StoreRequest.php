...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'accompanying_members'           => 'nullable|array',
            'accompanying_members.*'         => 'integer|exists:employees,id',
            'roasters.*.name'               => 'nullable|string|max:255',
    ...
    public function attributes()
    {
        return [
            ...
            'accompanying_members'           => 'Accompanying Members',
            'roaster_details'               => 'Roster Details',
