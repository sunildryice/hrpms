...
class FundRequestCancelSubmitted extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'=>route('approve.fund.requests.cancel.create', $this->fundRequest->id),
            'subject'=> 'Fund request '.$this->fundRequest->getFundRequestNumber().' has been submitted for cancellation.'
        ];
    }
