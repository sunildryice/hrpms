                ...
                <tr>
                    <td style="width: 50%">
                        @if (file_exists('storage/' . $employee->signature) && $employee->signature != '')
                            <a href="{!! asset('storage/' . $employee->signature) !!}" target="_blank" class="btn btn-outline-primary btn-sm"
                    ...
                    <td style="width: 50%">
                        @if (file_exists('storage/' . $employee->profile_picture) && $employee->profile_picture != '')
                            <a href="{!! asset('storage/' . $employee->profile_picture) !!}" target="_blank" class="btn btn-outline-primary btn-sm"
