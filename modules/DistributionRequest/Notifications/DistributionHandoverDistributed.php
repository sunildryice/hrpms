...
class DistributionHandoverDistributed extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link' => route('distribution.requests.handovers.show', $this->distributionHandover->id),
            'subject' => 'Distribution handover ' . $this->distributionHandover->getDistributionHandoverNumber() . ' has been handedover by ' . $this->distributionHandover->getReceiverName(),
        ];
    }
}
