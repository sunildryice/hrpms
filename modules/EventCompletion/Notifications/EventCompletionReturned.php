...
class EventCompletionReturned extends Notification
{
    use Queueable;
    ...
    {
        $url = route('event.completion.edit', $this->eventCompletion->id);
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'=>route('event.completion.edit', $this->eventCompletion->id),
            'subject'=> 'Event Completion Report has been returned.',
        ];
        }
