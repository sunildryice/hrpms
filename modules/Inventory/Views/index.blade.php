    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var oTable = $('#inventoryTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('inventories.index', ['grn_id' => $grn_id]) }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            <div class="brd-crms flex-grow-1">
                ...
                <div class="add-info justify-content-end">
                    <div class="justify-content-space-between">
                        <a href="{{ route('inventories.import.create') }}" class="btn btn-primary btn-sm">
                            <i class="bi bi-download"></i> Import Inventory
                        </a>
                        <a href="{{ route('inventories.create') }}" class="btn btn-primary btn-sm">
                            <i class="bi-plus"></i> New Inventory
                        </a>
                    </div>
                </div>
            </div>
