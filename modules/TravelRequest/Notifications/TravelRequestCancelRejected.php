...
class TravelRequestCancelRejected extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject' => 'Cancellation for Travel request ' . $this->travelRequest->getTravelRequestNumber() . ' has been rejected.'
        ];
    }
}
