...
@section('title', 'Edit Construction Progress')
...
@section('page_js')
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function (e) {
            ...
            $(document).on('click', '.open-progress-modal-form', function (e) {
                e.preventDefault();
                    ...
                    const fv = FormValidation.formValidation(form, {
                        fields: {
                            ...
                            progress_percentage: {
                                validators: {
                                    notEmpty: {
                                        message: 'Work Progress is required',
                                    },
                                    lessThan: {
                        ...
                        plugins: {
                            ...
                            signedDateReportDateFrom: new FormValidation.plugins.StartEndDate({
                                format: 'YYYY-MM-DD',
                                startDate: {
                                    field: 'signed_date',
                                    message: 'Signed Date must be a valid date and earlier than report date.',
                                },
                                endDate: {
                                    field: 'report_date',
                                    message: 'Report date must be a valid date and later than signed date.',
                                },
                            }),
                        ...
                        var successCallback = function (response) {
                            ...
                            constructionProgressTable.ajax.reload();

                        }
                        var errorCallback = function (response) {
                            if (response.responseJSON && response.responseJSON.status == 'error') {
                                // Display the error message on the page
                                showErrorMessageInSweatAlert(response);
                            } else if (response.status === 422 && response.responseJSON && response.responseJSON.errors) {
                                let errors = response.responseJSON.errors;
                                // Update the error messages on the page
                                Object.keys(errors).forEach(function(field) {
                                    var $input = $('input[name="' + field + '"]');
                                    if ($input.length) {
                                        $input.addClass('is-invalid');
                                        $input.siblings('.invalid-feedback').html(errors[field].join('<br>'));
                                    }
                                });
                            }
                        };

                        ajaxSubmitFormData($url, 'POST', data, successCallback, errorCallback);
                    });

                    $('#openModal').find('[name="report_date"]').datepicker({
                        language: 'en-GB',
                        autoHide: true,
                        format: 'yyyy-mm-dd',
                        ...
                        fv.revalidateField('report_date');
                    });
                });
            ...
            var oTable = $('#constructionParyTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'contribution_percentage', name: 'contribution_percentage'},
            ...
            var constructionProgressTable = $('#constructionProgressTable').DataTable({
                processing: true,
                serverSide: true,
                ...
                columns: [
                    ...
                    // {data: 'work_completion_date', name: 'work_completion_date'},
            ...
            $('#constructionProgressTable').on('click', '.delete-record', function (e) {
                e.preventDefault();
                $object = $(this);
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('signed_date')) is-invalid @endif"
                                                type="text" readonly name="signed_date" value="{{ $construction->signed_date ? $construction->signed_date->format('Y-m-d') : ''  }}"/>
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('nepali_date')) is-invalid @endif"
                                                type="text" readonly name="nepali_date" value="{{ $construction->getSignedBsDate() }}"/>
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="validationdd" class="form-label required-label">Health Facility Name</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('health_facility_name')) is-invalid @endif"
                                                type="text" readonly name="health_facility_name" value="{{ old('health_facility_name')?: $construction->health_facility_name }}"/>
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('effective_date_from')) is-invalid @endif"
                                                type="text"  readonly name="effective_date_from" value="{{ $construction->getEffectiveFromDate() }}"/>
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="validationdd" class="form-label required-label">Type of Facility</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('facility_type')) is-invalid @endif"
                                                type="text" readonly name="facility_type" value="{{ old('facility_type')?: $construction->facility_type }}"/>
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('effective_date_from_bs')) is-invalid @endif"
                                                type="text" readonly name="effective_date_from_bs" value="{{ $construction->getEffectiveFromBsDate() }}"/>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('type_of_work')) is-invalid @endif"
                                                type="text" readonly name="type_of_work" value="{{ old('type_of_work')?: $construction->type_of_work }}"/>
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('effective_date_from')) is-invalid @endif"
                                                type="text" readonly  name="effective_date_from" value="{{ $construction->getEffectiveToDate() }}"/>
                                        @if($errors->has('effective_date_from'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div data-field="effective_date_from">
                                                    {!! $errors->first('effective_date_from') !!}
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-3">
                                            ...
                                            <select name="province_id" class="select2 form-control" data-width="100%" disabled>
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('effective_date_bs_to')) is-invalid @endif"
                                                type="text" readonly name="effective_date_bs_to" value="{{ $construction->getEffectiveToBsDate() }}"/>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-3">
                                            ...
                                            <select name="district_id" class="select2 form-control" data-width="100%" disabled>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="validationdd" class="m-0">OHW Contribution Amount</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('ohw_contribution')) is-invalid @endif"
                                                type="number" readonly name="ohw_contribution" value="{{$construction->ohw_contribution}}"/>
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="engineer_id_2" class="m-0">Engineer Name</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <input class="form-control @if($errors->has('total_contribution_percentage')) is-invalid @endif"
                                                type="number" readonly name="total_contribution_percentage" value="{{ $construction->total_contribution_percentage }}"/>
                                ...
                                {{-- <div class="row mb-2">
                                    ...
                                    <div class="col-lg-3">
                                       <input type="text" readonly class="form-control @if($errors->has('metal_plaque_text')) is-invalid @endif" name="metal_plaque_text" value="{{$construction->metal_plaque_text}}" placeholder="Metal Plaque Text">
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="validationdd" class="form-label required-label">Total Estimate Cost</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <input type="number" readonly name="total_contribution_amount" class="form-control" value="{{ $construction->total_contribution_amount }}">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="physicallyabled"
                                                name="approval" @if ($construction->approval == 1) checked @endif disabled>
                                ...
                                <div class="card">
                                    <div class="card-header fw-bold">
                                        Project Progress
                                        @if ($authUser->can('addProgress', $construction))
                                            <div style="float: right">
                                                <button data-toggle="modal"
                                                        class="btn btn-primary btn-sm open-progress-modal-form"
                                                        href="{{route('construction.progress.create',$construction->id)}}"
                                                ><i class="bi-plus"></i> Add Progress</button>
                                            </div>
                                        @endif
                                    </div>
