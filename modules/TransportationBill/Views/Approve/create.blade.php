...
@section('title', 'Receive Transportation Bill')
...
@section('page_js')
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('transportationBillApproveForm');
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('approve.transportation.bills.index') }}"
                                        class="text-decoration-none">Transportation Bills</a>
                                </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('approve.transportation.bills.store', $transportationBill->id) }}"
                                id="transportationBillApproveForm" method="post" enctype="multipart/form-data"
                                autocomplete="off">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-5">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control" data-width="100%">
                                                        ...
                                                        <option value="12">Receive</option>
                                                    </select>
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                    ...
                                    <a href="{!! route('approve.transportation.bills.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
