...
@section('title', 'View Approved Worklog')
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a href="{!! route('approved.monthly.work.logs.index') !!}" class="text-decoration-none text-dark">Worklog</a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">Monthly Worklog View</li>
                    </ol>
                </nav>
