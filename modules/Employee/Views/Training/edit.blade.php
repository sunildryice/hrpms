...
<form class="g-3 needs-validation" action="{{ route('employees.trainings.update', ['employee','training']) }}"
      method="post" id="trainingEditForm" enctype="multipart/form-data" autocomplete="off">
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-lg-3">
