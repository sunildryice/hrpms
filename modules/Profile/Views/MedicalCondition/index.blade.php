<div class="card-header fw-bold">
    <h3 class="m-0 fs-6">Medical Information</h3>
</div>
@php
        $action = $employee->medicalCondition->created_at ? route('profile.medical.update', [$employee->medicalCondition->id]) :
            route('profile.medical.store');
@endphp

<form class="g-3 needs-validation" action="{{ $action }}" method="post" id="medicalConditionForm"
    ...
    <div class="card-body">
        ...
        <div class="row mb-2">
            <div class="col-lg-3">
                <div class="d-flex align-items-start h-100">
                    <label for="validationMedicalCondition" class="m-0">Medical Condition</label>
                </div>
            </div>
            <div class="col-lg-9">
