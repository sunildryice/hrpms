            ...
            <div class="col-lg-3">
                <div class="rounded border shadow-sm vertical-navigation pt-3 pb-3">
                    <ul class="m-0 list-unstyled v-mneu">
                        ...
                        <li class="nav-item"><a href="#" data-tag="tenure-details"
                                class="nav-link step-item text-decoration-none"><i
                        ...
                        <li class="nav-item"><a href="#" data-tag="education-details"
                                class="nav-link step-item text-decoration-none"><i
                        ...
                        <form class="g-3 needs-validation" novalidate>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" data-toggle="datepicker" class="form-control" id="validationdob"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <select id="validationGender" class="select2" placeholder="Select a Gender..."
                                        autocomplete="off">
                    ...
                    <div class="card-body">
                        <form class="g-3 needs-validation" novalidate>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <select id="validationprovience" class="select2" placeholder="Select a Provience..."
                                        autocomplete="off">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <select id="validationprovience" class="select2" placeholder="Select a District..."
                                        autocomplete="off">
                            ...
                            <div class="row mb-3 ">
                                <div class="col-lg-12">
                                    <div class="d-flex align-items-center h-100 border-bottom p-1 mb-2">
                                        <label for="validationcurrent" class="m-0"><input type="checkbox" name=""
                                                id="validationcurrent"> Same as Current Address
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <select id="validationdistrict2" class="select2" placeholder="Select a District..."
                                        autocomplete="off">
                                        <option value="">Select a District...</option>
                                        <option value="1">Kathmandu</option>
                                        <option value="2">Bhaktapur</option>
