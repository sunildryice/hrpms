                    ...
                    <div class="nav-item">
                        ...
                        <div class="nav-item">
                            <a class="nav-link dropdown-toggle" href="#navbarTimesheetMenuName" role="button"
                                data-bs-toggle="collapse" data-bs-target="#navbarTimesheetMenuName"
                                aria-expanded="false" aria-controls="#navbarTimesheetMenuName"
                                data-bs-toggle="tooltip" data-bs-placement="right" title="Timesheets">
                        ...
                        @if ($authUser->can('local-travel') || $authUser->can('approve-local-travel') || $authUser->can('pay-local-travel'))
                            <div class="nav-item">
                                ...
                                <div id="navbarLocalTravelMenuName" class="nav-collapse collapse"
                                    data-bs-parent="#navbarTravelMenu" hs-parent-area="#navbarTravelMenu"
                                    style="">
                                    ...
                                    @if ($authUser->can('pay-local-travel'))
                                        <a class="nav-link"
                                            href="{{ route('paid.local.travel.reimbursements.index') }}"
                        ...
                        @if (
                            ...
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle" href="#navbarTravelMenuName" role="button"
                                    ...
                                    aria-expanded="false" aria-controls="navbarTravelMenuName"
                                    data-bs-toggle="tooltip" data-bs-placement="right" title="Travel">
                                ...
                                <div id="navbarTravelMenuName" class="nav-collapse collapse"
                                    ...
                                    @if ($authUser->can('approve-travel-form'))
                                        ...
                                        <a class="nav-link"
                                            href="{{ route('approve.travel.requests.cancel.index') }}"
                        ...
                        @if (
                            ...
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle" href="#navbarVehicleMenuName" role="button"
                                    ...
                                    aria-expanded="false" aria-controls="navbarVehicleMenuName"
                                    data-bs-toggle="tooltip" data-bs-placement="right" title="Vehicle">
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarMaintenanceMenuName" class="nav-collapse collapse"
                                    ...
                                    @if ($authUser->can('approve-maintenance-request') || $authUser->can('view-approved-maintenance-request'))
                                        <a class="nav-link"
                                            href="{{ route('approved.maintenance.requests.index') }}"
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarGoodRequestMenuName" class="nav-collapse collapse"
                                    ...
                                    @if ($authUser->can('direct-dispatch-good-request'))
                                        <a href="{{ route('good.requests.direct.dispatch.index') }}"
                                            class="nav-link" id="direct-dispatch-menu">Direct Dispatch Requests</a>
                                    @endif
                                    ...
                                    @endif
                                    {{-- @if ($authUser->can('approve-direct-dispatch-good-request')) --}}
                                    <a href="{{ route('approve.good.requests.direct.assign.index') }}"
                                        class="nav-link" id="approve-direct-assign-menu">Approve Direct Assign</a>
                                    {{-- @endif --}}
                                    ...
                                    @endif
                                    <a class="nav-link"
                                        href="{{ route('receive.good.requests.direct.assign.index') }}"
                        ...
                        @if ($authUser->can('manage-privilege'))
                            ...
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle" href="#navbarPrivilege" role="button"
                                    ...
                                    aria-controls="navbarPrivilege" data-bs-toggle="tooltip"
                                    data-bs-placement="right" title="Privilege">
                                ...
                                <div id="navbarPrivilege" class="nav-collapse collapse"
                                    data-bs-parent="#navbarPrivilegeMenuName"
                                    hs-parent-area="#navbarPrivilegeMenuName" style="">
                            ...
                            <div class="nav-item">
                                ...
                                @endif --}}
                                    ...
                                    @if ($authUser->can('manage-probationary-indicator'))
                                        <a class="nav-link"
                                            href="{{ route('master.probationary.indicators.index') }}"
                        ...
                        @if ($authUser->can('view-report'))
                            <div class="nav-item">
                                ...
                                <div id="navbarReportMenuName" class="nav-collapse collapse"
                                    ...
                                    @if ($authUser->can('stock-book-report'))
                                        <a class="nav-link"
                                            href="{{ route('report.stock.book.distribution.index') }}"
