...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approve-good-requests-menu').addClass('active');
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('goodRequestApproveForm');
            const fv = FormValidation.formValidation(form, {
                fields: {
                    ...
                    logistic_officer_id: {
                        validators: {
                            notEmpty: {
                                message: 'Logistic officer is required.',
                            },
                        },
                    },
                    log_remarks: {
                ...
                plugins: {
                    ...
                    excluded: new FormValidation.plugins.Excluded({
                        excluded: function(field, ele, eles) {
                            ...
                            return (field === 'logistic_officer_id' && statusId !== "{{config('constant.APPROVED_STATUS')}}");
                        },
                    }),
            ...
            $(form).on('change', '[name="status_id"]', function(e) {
                ...
                if (this.value == "{{config('constant.APPROVED_STATUS')}}") {
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('review.good.requests.index') }}" class="text-decoration-none">Good
                                        Requests</a>
                                </li>
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                    ...
                                    <a href="{!! route('review.good.requests.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
