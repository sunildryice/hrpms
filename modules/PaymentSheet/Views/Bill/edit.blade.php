...
<section class="registration">
    <div class="card">
        <form action="{{ route('payment.bills.update', $paymentBill->id) }}" id="paymentBillEditForm" method="post"
                    ...
                    <div class="col-lg-4">
                        <select class="select2 form-control @if($errors->has('supplier_id')) is-invalid @endif"
                            ...
                            @foreach($suppliers as $supplier)
                                <option value="{{ $supplier->id }}" @if($supplier->id == $paymentBill->supplier_id) selected
                                @endif>{{ $supplier->getSupplierName() }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-4">
                        <select class="select2 form-control @if($errors->has('category_id')) is-invalid @endif"
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" @if($category->id == $paymentBill->category_id) selected
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        <input class="form-control @if($errors->has('bill_date')) is-invalid @endif" name="bill_date"
                            value="{{ old('bill_date') ?: ($paymentBill->bill_date ? $paymentBill->bill_date->format('Y-m-d') : "") }}"
                            readonly />
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        <input class="form-control @if($errors->has('bill_amount')) is-invalid @endif"
                            name="bill_amount" value="{{ old('bill_amount') ?: $paymentBill->bill_amount }}"
                            type="number" />
                    ...
                    <div class="col-lg-4">
                        <div class=" form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked"
                                name="vat_applicable" @if(old('vat_applicable') || $paymentBill->vat_flag) checked
                                @endif>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-4">
                        <input type="number" class="form-control" readonly name="vat_amount"
                            value="{{ old('vat_amount') ?: $paymentBill->vat_amount }}" />
                    </div>
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                    ...
                    <div class="col-lg-4">
                        <input type="number" class="form-control" readonly name="total_amount"
                            value="{{ old('total_amount') ?: $paymentBill->total_amount }}" />
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-10">
                        ...
                        @if(file_exists('storage/' . $paymentBill->attachment) && $paymentBill->attachment != '')
                            <div class="media">
                                <a href="{{ asset('storage/' . $paymentBill->attachment) }}" target="_blank"
