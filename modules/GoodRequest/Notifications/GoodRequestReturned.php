...
class GoodRequestReturned extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->greeting('Hello!')
            ->line('Goods Request ' . $this->goodRequest->getGoodRequestNumber() . ' has been returned.')
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject' => 'Goods Request ' . $this->goodRequest->getGoodRequestNumber() . ' has been returned.'
        ];
    }
}
