            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" type="text" value="{{ $performanceReview->getEmployeeName() }}"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" type="text" value="{{ $performanceReview->getReviewType() }}"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-3">
                            <label for="external_reviewer_id" class="form-label">External Reviewer</label>
                        </div>
                        <div class="col-lg-9">
                            <select class="form-control select2" name="external_reviewer_id" id="external_reviewer_id">
                                <option value="">Select External Reviewer</option>
                                @foreach ($employees as $employee)
                                    @if ($employee->user)
                                        <option value="{{ $employee->user->id }}"
                                            {{ $performanceReview->external_reviewer_id == $employee->user->id ? 'selected' : '' }}>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" type="text" value="{{ $performanceReview->getFiscalYear() }}"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control @if ($errors->has('review_from')) is-invalid @endif"
                                name="review_from" id="review_from"
                                value="{{ $performanceReview->review_from->format('Y-m-d') }}" autocomplete="off">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control @if ($errors->has('review_to')) is-invalid @endif"
                                name="review_to" id="review_to"
                                value="{{ $performanceReview->review_to->format('Y-m-d') }}" autocomplete="off">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-3">
                            <input type="text" class="form-control @if ($errors->has('deadline_date')) is-invalid @endif"
                                ...
                                value="{{ $performanceReview->deadline_date?->format('Y-m-d') }}" autocomplete="off">
