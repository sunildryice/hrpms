...
@section('title', __('label.items'))

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#items-menu').addClass('active');
            ...
            $('#itemTable').on('click', '.delete-record', function(e) {
                e.preventDefault();
                $object = $(this);
            ...
            $(document).on('click', '.open-item-modal-form', function(e) {
                ...
                $('#openModal').modal('show').find('.modal-content').load($(this).attr('href'), function (){
                    ...
                    $(form).on('change', '[name="inventory_category_id"]', function(e) {
                        fv.revalidateField('inventory_category_id');
                    });
                });
            });
        });
                        ...
                        <table class="table" id="itemTable">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('label.item-code') }}</th>
