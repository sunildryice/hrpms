...
@section('title', 'Assets On Store Detail')
@php
    $authUser = auth()->user();
@endphp
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.open-asset-recover-modal-form', function(e) {
                e.preventDefault();
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="m-0 breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{!! route('assets.store.index') !!}" class="text-decoration-none">Assets on Store</a>
                                </li>
                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <span>
                                            @can('manage-asset-logistic')
                                                <a data-toggle="modal"
                                                    class="btn btn-outline-success btn-sm open-asset-recover-modal-form"
                                                    href="{{ route('assets.recover.create', $asset->id) }}" rel="tooltip"
                                                    title="Recover"><i class="bi-arrow-repeat"></i> Recover Asset Location</a>
                                            @endcan
                                        </span>
                                    </div>
                                    <div class="card-body">
