                            ...
                            <form action="{{ route('construction.update', $construction->id) }}" id="constructionAddForm"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-3">
                                            <input class="form-control signed_date_nepali @if ($errors->has('nepali_date')) is-invalid @endif"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-3">
                                            <input
                                                ...
                                                value="{{ old('ohw_contribution') ?: $construction->ohw_contribution }}" readonly/>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="select2" name="engineer_id" id="engineer_id">
                                                ...
                                                @foreach ($engineers as $engineer)
                                                    <option value="{{$engineer->id}}" {{$engineer->id == $construction->engineer_id ? 'selected' : ''}}>{{$engineer->getFullName()}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-3">
                                           <input type="text" class="form-control @if($errors->has('work_start_date')) is-invalid @endif" name="work_start_date" value="{{$construction->work_start_date?->format('Y-m-d')}}" placeholder="Work start date">
                                        ...
                                        <div class="col-lg-3">
                                           <input type="text" class="form-control @if($errors->has('work_completion_date')) is-invalid @endif" name="work_completion_date" value="{{$construction->work_completion_date?->format('Y-m-d')}}" placeholder="Work completion date">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-3">
                                           ...
                                           {{-- <select class="form-control select2 @if($errors->has('donor_codes')) is-invalid @endif" name="donor_codes[]" id="donor_codes" multiple>
                                           ...
                                           <input type="text" class="form-control @if($errors->has('donor')) is-invalid @endif"
                                        ...
                                        <div class="col-lg-3">
                                           {{-- <input type="text" class="form-control @if($errors->has('metal_plaque_text')) is-invalid @endif"
                                           name="metal_plaque_text" value="{{$construction->metal_plaque_text}}" placeholder="Metal Plaque Text"> --}}

                                           <textarea class="form-control @if($errors->has('metal_plaque_text')) is-invalid @endif" placeholder="Metal Plaque Text"
                                            name="metal_plaque_text" id="metal_plaque_text" rows="2">{{ $construction->metal_plaque_text }}</textarea>
