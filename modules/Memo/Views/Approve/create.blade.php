...
@section('page_js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#navbarVerticalMenu').find('#approve-memo-menu').addClass('active');
        });

        document.addEventListener('DOMContentLoaded', function (e) {
            const form = document.getElementById('memoApproveForm');
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('approve.memo.index') }}"
                                class="text-decoration-none">Approve Memo List</a></li>
                            <li class="breadcrumb-item" aria-current="page">Approve Memo</li>
                        </ol>
                    </nav>
                    <h4 class="m-0 lh1 mt-1 fs-6 text-uppercase fw-bold text-primary">Approve Memo</h4>
                </div>
            </div>
        </div>
        <section class="registration">
            ...
            @include('Memo::Partials.detail')
                ...
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                    ...
                                    <div class="col-lg-7">
                                        <form action="{{ route('approve.memo.store', $memo->id) }}"
                                            id="memoApproveForm"
                                            method="post"
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <select name="status_id" class="select2 form-control" data-width="100%">
                                                            ...
                                                            @if($memo->status_id == 4 || $memo->status_id == 5 || in_array($userId, $memo->getToUserId()))
