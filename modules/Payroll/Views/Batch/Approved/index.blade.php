...
@section('title', 'Approved Payroll Batches')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approved-payroll-batches-menu').addClass('active');

            var oTable = $('#approvedPayrollBatchTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('approved.payroll.batches.index') }}",
                columns: [{
                        data: 'fiscal_year',
                        name: 'fiscal_year',
                        searchable: false,
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="approvedPayrollBatchTable">
