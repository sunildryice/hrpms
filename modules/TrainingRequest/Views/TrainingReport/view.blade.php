...
@section('title', 'Training Report View')
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('training.report.index') }}" class="text-decoration-none text-dark">Training
                                Request</a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">Training Report View</li>
                    </ol>
                </nav>
                <h4 class="m-0 lh1 mt-1 fs-6 text-uppercase fw-bold text-primary">Training Report View</h4>
            </div>
        </div>
    </div>
    <section class="registration">
        <div class="row">
            ...
            <div class="col-lg-9">
                            ...
                            @foreach ($trainingRequestQuestions as $trainingRequestQuestion)
                                @if (
                                    ...
                                    <div class="mb-3 border-bottom pb-2 mb-2">
                                        ...
                                        <p><i
                                                class="me-2"><strong>Answer:</strong></i>{{ $trainingRequestQuestion->answer }}g
                                        </p>
                                    </div>
                                @endif
                            @endforeach
                        ...
                        @if ($trainingReportQuestions->count() > 0)
                            @foreach ($trainingReportQuestions as $trainingReportQuestion)
                                @if (
                                    ...
                                    <div class="mb-3 border-bottom pb-2 mb-2">
                                        <label
                                            for="">{{ $trainingReportQuestion->trainingQuestion->question }}</label>
                                        <p><i
                                                class="me-2"><strong>Answer:</strong></i>{{ $trainingReportQuestion->answer }}g
                                        </p>
                                    </div>
                                @endif
                            @endforeach
                ...
                <div class="card">
                    <div class="card-header fw-bold">
                        Training Report Remarks
                    </div>
                    <div class="card-body">
                        <div class="c-b">
                            @if ($trainingReport->logs->count() > 0)
