...
@section('title', 'Check Fund Request')
...
@section('page_js')
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
                ...
                plugins: {
                    ...
                    excluded: new FormValidation.plugins.Excluded({
                        excluded: function(field, ele, eles) {
                            ...
                            return (field === 'certifier_id' && statusId !== 11) || (field ===
            ...
            }).on('change', '[name="certifier_id"]', function(e) {
                fv.revalidateField('certifier_id');
            });
        });
    </script>
@endsection
        ...
        <div class="container-fluid">
            ...
            <section class="registration">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <form action="{{ route('check.fund.requests.store', $fundRequest->id) }}" id="fundRequestReviewForm"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            @include('FundRequest::Partials.fund-request-activities-review')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control"
                                                        ...
                                                        <option value="{{ config('constant.VERIFIED_STATUS') }}">Verify
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="row mb-2" id="certifyBlock" style="display:none ;">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="certifier_id" class="select2 form-control"
                                                        data-width="100%">
                                                        <option value="">Select Certifiers</option>
                                                        @foreach ($certifiers as $approver)
