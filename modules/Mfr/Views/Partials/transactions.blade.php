                                ...
                                <table class="table table-bordered" id="transactionTable">
                                    ...
                                    <tbody>
                                        @php
                                            ...
                                            $transactions = $transactions->orderBy('transaction_date')->get();
                                        ...
                                        @foreach ($transactions as $value)
                                            <tr>
                                                ...
                                                <td
                                                    style="min-width: 300px; max-width: 350px; white-space: pre-line; left: 0px; ">
                                                    {{ $value->remarks }}</td>
                                                <td class="text-end">{{ $value->release_amount }}</td>
                                                <td class="text-end">{{ $value->expense_amount }}</td>
                                                <td class="text-end">{{ $value->reimbursed_amount }}</td>
                                                <td class="text-end">
                                                    {{ $value->expense_amount - $value->reimbursed_amount }}
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td id="total_itinerary_amount" class="text-end"> {{ $totalReimbursed }}
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td id="grand_total_amount" class="text-end">
                                                {{ $totalRelease - $totalExpense }} </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">Fund Transfer %</td>
                                            <td id="advance_amount" class="text-end">
                                                {{ $transaction->agreement->getApprovedBudget() ? round(($totalRelease / $transaction->agreement->getApprovedBudget()) * 100, 2) : 0 }}%
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
