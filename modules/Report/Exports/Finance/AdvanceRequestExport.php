...
class AdvanceRequestExport implements Responsable, WithHeadings, WithMapping, FromCollection, ShouldAutoSize, WithStyles, WithCustomStartCell, WithEvents
{
    use Exportable;
    ...
    */
    private $fileName = 'advance_request_and_settlement_report.xlsx';
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Advance Request and Settlement Log Report');
                $styleArray = [
                    'alignment' => [
    ...
    */
    ...
    public function map($record): array
    {
        return [
            $this->counter++,
            $record->getAdvanceRequestNumber(),
            $record->getRequesterName(),
            $record->office->office_name,
            $record->purpose,
            $record->getEstimatedAmount(),
            '',
            $record->end_date,
