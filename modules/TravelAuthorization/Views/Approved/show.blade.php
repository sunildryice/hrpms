...
@section('title', 'View Travel Authorization Request')
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('approved.ta.requests.index') }}"
    ...
    <section class="registration">
        <div class="row">
            <div class="col-lg-3">
                ...
                @if ($travel->parentTravelAuthorization)
                    <a class="btn btn-sm btn-primary mt-2"
                        href="{{ route('ta.requests.view', $travel->parentTravelAuthorization->id) }}" target="_blank"
