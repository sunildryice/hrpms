...
@section('page_js')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            ...
            const formSubmit = document.getElementById('ProbationReviewRecommendForm');
            const fvSubmit = FormValidation.formValidation(formSubmit, {
                fields: {
                    status_id: {
                        validators: {
                            notEmpty: {
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page">
                        <a href="{!! route('probation.review.detail.requests.index') !!}"
                            class="text-decoration-none text-dark">Review Requests</a>
                    </li>
...
<section class="registration">
        ...
        <form action="{!! route('probation.review.detail.requests.update', $probationaryReview->id) !!}" method="post"
            ...
            <div class="card-body">
                ...
                @foreach($probationaryReviewIndicators as $probationaryReviewIndicator)
                    <div class="row mb-3">
                        <label for="" class="">{{ $loop->iteration }}.
                            {{$probationaryReviewIndicator->getIndicator() }}</label>
                        <div class="mt-2">
                            <div class="row">
                                <div class="col-lg-3">
                                    <input type="radio"
                                        name="indicator[{{$probationaryReviewIndicator->probationary_indicator_id}}]"
                                        class="" value='improved_required'
                                        @if($probationaryReviewIndicator->improved_required == 1) checked
                                        @endif>&nbsp;Improvement Required
                                </div>
                                <div class="col-lg-3">
                                    <input type="radio"
                                        name="indicator[{{$probationaryReviewIndicator->probationary_indicator_id}}]"
                                        class="" value="satisfactory" @if($probationaryReviewIndicator->satisfactory == 1)
                                        checked @endif>&nbsp;Satisfactory
                                </div>
                                <div class="col-lg-3">
                                    <input type="radio"
                                        name="indicator[{{$probationaryReviewIndicator->probationary_indicator_id}}]"
                                        class="" value="good" @if($probationaryReviewIndicator->good == 1) checked
                                        @endif>&nbsp;Good
                                </div>
                                <div class="col-lg-3">
                                    <input type="radio"
                                        name="indicator[{{$probationaryReviewIndicator->probationary_indicator_id}}]"
                                        class="" value="excellent" @if($probationaryReviewIndicator->excellent == 1) checked
                                        @endif>&nbsp;Excellent
                                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="mt-2">
                        <textarea rows="5"
                            class="form-control @if($errors->has('performance_improvements')) is-invalid @endif"
                            name="performance_improvements">@if($probationaryReview->performance_improvements){{ $probationaryReview->performance_improvements}}@endif</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="mt-2">
                        <textarea rows="5"
                            class="form-control @if($errors->has('concern_address_summary')) is-invalid @endif"
                            name="concern_address_summary">@if($probationaryReview->concern_address_summary){{ $probationaryReview->concern_address_summary}}@endif</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="mt-2">
                        <textarea rows="5"
                            class="form-control @if($errors->has('employee_performance_progress')) is-invalid @endif"
                            name="employee_performance_progress">@if($probationaryReview->employee_performance_progress){{ $probationaryReview->employee_performance_progress}}@endif</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="mb-3 col-6">
                            ...
                            <div class="mt-2">
                                <div class="mt-2">
                                    <textarea rows="2"
                                        class="form-control @if($errors->has('objectives_review_remarks')) is-invalid @endif"
                                        name="objectives_review_remarks">@if($probationaryReview->objectives_met == 0){{ $probationaryReview->objectives_review_remarks}}@endif</textarea>
                                </div>
                            </div>
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <div class="mt-2">
                                <input type="text"
                                    class="form-control @if($errors->has('objectives_review_date')) is-invalid @endif"
                    ...
                    <div class="col-lg-9">
                        <div class=" form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="q3"
                                name="development_addressed" @if($probationaryReview->development_addressed == 1) checked
                                @endif>
                    ...
                    <div class="row">
                        <div class="mb-3 col-6">
                            ...
                            <div class="mt-2">
                                <div class="mt-2">
                                    <textarea rows="2"
                                        class="form-control @if($errors->has('development_review_remarks')) is-invalid @endif"
                                        name="development_review_remarks">@if($probationaryReview->development_addressed == 0){{$probationaryReview->development_review_remarks}}@endif</textarea>
                                </div>
                            </div>
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <div class="mt-2">
                                <input type="text"
                                    class="form-control @if($errors->has('development_review_date')) is-invalid @endif"
                ...
                <div class="row mb-3">
                    ...
                    <div class="mt-2">
                        <textarea rows="5"
                            class="form-control  @if($errors->has('supervisor_recommendation')) is-invalid @endif"
                            name="supervisor_recommendation">@if($probationaryReview->supervisor_recommendation){{$probationaryReview->supervisor_recommendation}}@endif</textarea>
                    </div>
                ...
                {{-- <div class="row mb-3">
                    ...
                    <div class="mt-2">
                        <textarea rows="5"
                            class="form-control  @if($errors->has('director_recommendation')) is-invalid @endif"
                            name="director_recommendation">@if($probationaryReview->director_recommendation){{$probationaryReview->director_recommendation}}@endif</textarea>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-lg-9">
                        <div class=" form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="q3"
                                name="appointment_confirmed" @if($probationaryReview->appointment_confirmed == 1) checked
                                @endif>
                ...
                <div class="appointment_confirmed {{$appointment_confirmed_display}}">
                    <div class="row mb-3">
                        ...
                        <div class="mt-2">
                            <textarea rows="5"
                                class="form-control @if($errors->has('reason_to_address_difficulty')) is-invalid @endif"
                                name="reason_to_address_difficulty">@if($probationaryReview->appointment_confirmed == 0){{$probationaryReview->reason_to_address_difficulty}}@endif</textarea>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-9">
                            <div class=" form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="q3"
                                    name="probation_extended" @if($probationaryReview->probation_extended == 1) checked
                                    @endif>
                    ...
                    <div class="probation_extended {{$probation_extended_display}}">
                        <div class="row mb-3">
                            ...
                            <div class="mt-2">
                                <textarea rows="5"
                                    class="form-control @if($errors->has('reason_and_improvement_to_extend')) is-invalid @endif"
                                    name="reason_and_improvement_to_extend">@if($probationaryReview->probation_extended == 1){{ $probationaryReview->reason_and_improvement_to_extend}}@endif</textarea>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <div class="mt-2">
                                    <input type="number"
                                        class="form-control @if($errors->has('extension_length')) is-invalid @endif"
                            ...
                            <div class="mb-3 col-6">
                                <label for=""
                                    class="required-label">{{__('label.next-probation-complete-date')}}</label>
                                <div class="mt-2">
                                    <input type="text"
                                        class="form-control @if($errors->has('next_probation_complete_date')) is-invalid @endif"
    ...
    <div class="card">
        <div class="card-body">
            ...
            @if($authUser->can('recommend', $probationaryReview))
                <form action="{!! route('probation.review.detail.requests.storeRecommend', $probationaryReview->id) !!}"
                    method="post" enctype="multipart/form-data" id="ProbationReviewRecommendForm" autocomplete="off">
                    {!! csrf_field() !!}
                    ...
                    <div class="row mb-3 col-6">
                        ...
                        <div class="mt-2">
                            <select name="status_id" class="select2 form-control" data-width="100%">
                                ...
                                <option value="15" @if(old('status_id') == '15') selected @endif>Return to Employee</option>
                                <option value="11" @if(old('status_id') == '11') selected @endif>Verify</option>
                            </select>
                    ...
                    <div class="row mb-3 col-6">
                        <label for="" class="m-0">{{__('label.approver')}}</label>
                        <div class="mt-2">
                            <input name="approver" class="form-control"
                                value="{!! $probationaryReview->getApproverName() !!}">
                        </div>
                    </div>
                    <div class="card-footer border-0 justify-content-end d-flex gap-2">
