                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <input
                                        ...
                                        type="text" readonly name="health_facility_name"
                                ...
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-start h-100">
                                        <label for="validationdd" class="form-label required-label">Effective Date AD
                                            From</label>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <input
                                        ...
                                        type="text" readonly name="effective_date_from"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control @if($errors->has('facility_type')) is-invalid @endif"
                                        type="text" readonly name="facility_type"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control @if($errors->has('type_of_work')) is-invalid @endif"
                                        type="text" readonly name="type_of_work"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control @if($errors->has('ohw_contribution')) is-invalid @endif"
                                        type="number" readonly name="ohw_contribution"
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" disabled name="engineer_id" id="engineer_id"
                                        value="{{$construction->getEngineerName()}}">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-start h-100">
                                        <label for="validationdd" class="form-label required-label">Total Estimate
                                            Cost</label>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <input type="number" readonly name="total_contribution_amount" class="form-control"
                                        value="{{ $construction->total_contribution_amount }}">
                                    ...
                                    @if ($authUser->can('addProgress', $construction))
                                        <div style="float: right">
                                            <button data-toggle="modal"
                                                ...
                                                href="{{route('construction.progress.create', $construction->id)}}"><i
                                                    class="bi-plus"></i> Add Progress</button>
                                        </div>
                                    @endif
                                </div>
