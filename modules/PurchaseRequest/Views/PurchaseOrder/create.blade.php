...
@section('page_js')
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            ...
            const purchaseReqItems = @json($items);
            var ltas = [];
            ...
            $(form).on('change', '[name="supplier_id"]', function(e) {
                ...
                $(element).closest('form').find('[name="lta_contract_id"]').html(
                            optionField);
                $(form).find('.purchaseItem').prop('checked', false).trigger(
                            'change');
                if (supplierId) {
                ...
                if (ltaId) {
                    ...
                    $.each(purchaseReqItems, function(index, purchaseReqItem) {
                        const ltaItem = ltaItems.find(ltaItem => ltaItem.item_id == purchaseReqItem.item_id);
                        if (ltaItem) {
                            $('#unit-price-' + purchaseReqItem.id).val(ltaItem.unit_price).trigger(
                                'change');
            ...
            var selectedSupplierId = '{{ old('supplier_id') }}';
            ...
            //     var itemId = $(this).val();
            //     var quantityInput = $('input[name="order_quantity[' + itemId + ']"]');
            //     var priceInput = $('input[name="unit_price[' + itemId + ']"]');
...
@section('page-content')
    ...
    <section class="registration">
        <form action="{{ route('approved.purchase.requests.orders.store', $purchaseRequest->id) }}"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            @php $selectedDistrictId = old('district_ids') ?: []; @endphp
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            @php $selectedSupplierId = old('supplier_id'); @endphp
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9">
                            <select class="select2 form-control" name="lta_contract_id">
                                <option value="">Select an LTA</option>
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-center">
                                <select class="form-control @if ($errors->has('currency_id')) is-invalid @endif"
                                    ...
                                    @foreach ($currencies as $currency)
                                        <option value="{{ $currency->id }}">{{ $currency->getTitle() }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="table-responsive table-container">
                                <table class="table table-bordered" id="purchaseRequestItemTable">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($items as $purchaseRequestItem)
                                        @php
