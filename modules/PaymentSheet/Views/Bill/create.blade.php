...
@section('title', 'Add New Payment Bill')

@section('page_js')
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function (e) {
            $('#navbarVerticalMenu').find('#payment-bills-menu').addClass('active');
            const form = document.getElementById('paymentBillAddForm');
...
<section class="registration">
    <div class="card">
        <form action="{{ route('payment.bills.store') }}" id="paymentBillAddForm" method="post"
            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                            <label for="validationdd" class="form-label">{{ __('label.bill-category') }}</label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <select class="select2 form-control @if($errors->has('category_id')) is-invalid @endif"
                            name="category_id">
                ...
                <div class="row mb-2">
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                            <label for="validationdd"
                                class="form-label required-label">{{ __('label.bill-date') }}</label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <input class="form-control @if($errors->has('bill_date')) is-invalid @endif" name="bill_date"
                            value="{{ old('bill_date') }}" readonly />
                    ...
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                            <label for="validationdd"
                                class="form-label required-label">{{ __('label.bill-no') }}</label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <input class="form-control @if($errors->has('bill_number')) is-invalid @endif"
                            name="bill_number" value="{{ old('bill_number') }}" />
                ...
                <div class="row mb-2">
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                            <label for="validationdd" class="form-label">{{ __('label.bill-amount') }}</label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <input class="form-control @if($errors->has('bill_amount')) is-invalid @endif"
                            name="bill_amount" value="{{ old('bill_amount') }}" type="number" />
                    ...
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                            <label for="validationdd" class="form-label">{{ __('label.vat-applicable') }}</label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="row mb-2">
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                            <label for="validationdd" class="form-label">{{ __('label.vat-amount') }}</label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <input type="number" class="form-control" readonly name="vat_amount"
                            value="{{ old('vat_amount') }}" />
                    </div>
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                            <label for="validationdd" class="form-label">{{ __('label.total-amount') }}</label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <input type="number" class="form-control" readonly name="total_amount"
                ...
                <div class="row mb-2">
                    <div class="col-lg-2">
                        <div class="d-flex align-items-start h-100">
                            <label for="validationdd" class="form-label">{{ __('label.remarks') }}</label>
                        </div>
                    </div>
                    <div class="col-lg-10">
            ...
            <div class="card-footer border-0 justify-content-end d-flex gap-2">
                ...
                <a href="{!! route('payment.bills.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
            </div>
        </form>
    </div>
</section>
