...
@section('title', __('label.execution-type'))

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#execution-menu').addClass('active');

            var oTable = $('#executionTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.execution.types.index') }}",
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
            ...
            $('#executionTable').on('click', '.delete-record', function(e) {
                e.preventDefault();
                $object = $(this);
            ...
            $(document).on('click', '.open-modal-form', function(e) {
                ...
                $('#openModal').modal('show').find('.modal-content').load($(this).attr('href'), function (){
                    const form = document.getElementById('executionTypeForm');
            ...
            <div class="brd-crms flex-grow-1">
                ...
                <div class="add-info justify-content-end">
                    <button data-toggle="modal" class="btn btn-primary btn-sm open-modal-form"
                        href="{!! route('master.execution.types.create') !!}">
