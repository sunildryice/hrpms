...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('employee_requisition_logs', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('employee_requisition_id')->references('id')->on('employee_requisitions');
    ...
    {
        Schema::dropIfExists('employee_requisition_logs');
    }
};
