...
@section('title', 'Approved Training Report View')
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('training.report.index') }}" class="text-decoration-none text-dark">Training Request</a>
                                </li>
                                    ...
                                    @foreach($trainingReportQuestions as $trainingReportQuestion)
                                        @if($trainingReportQuestion->trainingQuestion->answer_type == 'textarea' && $trainingReportQuestion->trainingQuestion->type == '6')
                                            <div class="mb-3 border-bottom pb-2 mb-2">
                                                ...
                                                <p><i class="me-2"><strong>Answer:</strong></i>{{$trainingReportQuestion->answer}}g </p>
                                            </div>
                                        @endif
                                    @endforeach
                                @endif
