...
<form action="{!! route('performance.keygoals.store') !!}" method="post" enctype="multipart/form-data" id="keygoalImportForm"
    autocomplete="off">
    <div class="modal-body">
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                {{-- <a href="{{ route('performance.keygoals.export') }}" target="_blank">Download</a> a sample file.<br /> --}}
            </div>
        </div>
    </div>
