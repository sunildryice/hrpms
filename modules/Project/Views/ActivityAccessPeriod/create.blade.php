<div class="modal-header bg-primary text-white">
    <h5 class="modal-title mb-0 fs-6" id="openModalLabel">Create Activity Access Period</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    <form action="{{ route('activity-access-periods.store') }}" method="POST" id="activityAccessPeriodCreateForm"
        autocomplete="off">
        @csrf
        <div class="row g-3">
            <div class="col-md-6">
...
<div class="modal-footer">
    ...
    <button type="submit" form="activityAccessPeriodCreateForm" class="btn btn-primary">Save</button>
</div>
