...
@section('page-content')
            ...
            <section class="registration">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            <label class="form-label"> Employee Name: {{$probationaryReview->getEmployeeName()}}</label>
                        </div>
                        <div class="row mb-2">
                            <label class="form-label"> Designation Name: {{$probationaryReview->employee->getDesignationName()}}</label>
                        </div>
                        <div class="row mb-2">
                            <label class="form-label"> Department Name: {{$probationaryReview->employee->getDepartmentName()}}</label>
                        </div>
                        <div class="row mb-2">
                            <label class="form-label"> Joining Date: {{$probationaryReview->employee->getFirstJoinedDate()}}</label>
                        </div>

                    </div>
                </div>
                <div class="card">
                    <div class="card-header fw-bold">Indicators</div>
                    <div class="card-body">
                        @foreach($probationaryReviewIndicators as $probationaryReviewIndicator)
                            <div class="row mb-3">
                                <label class="form-label">{{ $loop->iteration }}. {{$probationaryReviewIndicator->getIndicator() }}</label>
                                <div class="mt-2">
                                    <div class="row">
                                        <div class="col-lg-3">
                        ...
                        <div class="row mb-3">
                            <label class="form-label">{{ __('label.performance-improvements') }}</label>
                            <div class="mt-2">
                                <textarea rows="5" class="form-control" name="" readonly
                                >@if($probationaryReview->performance_improvements){{ $probationaryReview->performance_improvements}}@endif</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="form-label">{{ __('label.concern-address-summary') }}</label>
                            <div class="mt-2">
                                <textarea rows="5" class="form-control" name="" readonly
                        ...
                        <div class="row mb-3">
                            <label class="form-label">{{ __('label.employee-performance-progress') }}</label>
                            <div class="mt-2">
                                <textarea rows="5" class="form-control" name="" readonly
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-9">
                                <div class="form-check form-switch">
                                    ...
                                    name="" @if($probationaryReview->objectives_met == 1) checked @endif>
                        ...
                        <div class="objectives_met {{$objectives_met_display}}">
                            <div class="row">
                                <div class="mb-3 col-6">
                                    <label class="form-label" class="">{{ __('label.review-remarks') }} </label>
                                    <div class="mt-2">
                                        <div class="mt-2">
                                ...
                                <div class="mb-3 col-6">
                                    <label class="form-label" class="required-label">{{ __('label.review-date') }} </label>
                                    <div class="mt-2">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-9">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch"
                                    name="" @if($probationaryReview->development_addressed == 1) checked @endif>
                        ...
                        <div class="row mb-3">
                            <label class="form-label" class="required-label">{{__('label.supervisor-recommendation')}}</label>
                            <div class="mt-2">
                        ...
                        <div class="row mb-3">
                            <label class="form-label" class="required-label">{{__('label.director-recommendation')}}</label>
                            <div class="mt-2">
                                <textarea rows="5" class="form-control"
                                    name="" readonly
                        ...
                        <div class="appointment_confirmed {{$appointment_confirmed_display}}">
                            <div class="row mb-3">
                                <label class="form-label">{{__('label.reason-to-address-difficulty')}}</label>
                                <div class="mt-2">
                                    <textarea rows="5" class="form-control"
                                        name="" readonly
                            ...
                            <div class="probation_extended {{$probation_extended_display}}">
                                <div class="row mb-3">
                                    <label class="form-label">{{__('label.reason-and-improvement-to-extend')}}</label>
                                    <div class="mt-2">
                                        <textarea rows="5" class="form-control" name="" readonly
                                ...
                                <div class="row">
                                    <div class="mb-3 col-6">
                                        <label class="form-label" class="required-label">{{__('label.extension-length')}}</label>
                                        <div class="mt-2">
                                            <input type="number" class="form-control"
                                            name="" readonly placeholder="Enter in months" min="1" max="3"
                                            value="@if($probationaryReview->probation_extended == 1){{ $probationaryReview->extension_length}}@endif">
                                        </div>
                                    </div>

                                    <div class="mb-3 col-6">
                                        <label class="form-label" class="required-label">{{__('label.next-probation-complete-date')}}</label>
                                        <div class="mt-2">
                                            <input type="text" class="form-control"
                                            name="" readonly
                        ...
                        <div class="row mb-3">
                            <label class="form-label">{{__('label.employee-comments')}}</label>
                            <div class="mt-2">
                                <textarea rows="5" class="form-control" name="" readonly>{{$probationaryReview->employee_remarks}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
