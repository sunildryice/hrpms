...
@section('title', __('label.dsa-categories'))

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#dsa-categories-menu').addClass('active');

            var oTable = $('#dsaCategoryTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.dsa.categories.index') }}",
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
            ...
            $('#dsaCategoryTable').on('click', '.delete-record', function(e) {
                e.preventDefault();
                $object = $(this);
            ...
            $(document).on('click', '.open-dsa-modal-form', function(e) {
                e.preventDefault();
                $('#openModal').find('.modal-content').html('');
                $('#openModal').modal('show').find('.modal-content').load($(this).attr('href'), function (){
                    const form = document.getElementById('dsaCategoryForm');
            ...
            <div class="brd-crms flex-grow-1">
                ...
                <div class="add-info justify-content-end">
                    <button data-toggle="modal" class="btn btn-primary btn-sm open-modal-form"
                        href="{!! route('master.dsa.categories.create') !!}">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="dsaCategoryTable">
