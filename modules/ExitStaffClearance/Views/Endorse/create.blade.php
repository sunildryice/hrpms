...
@section('title', 'Endorse Exit Staff Clearance')

@section('page_js')
    <script type="text/javascript">
        document.addEventListener("DOMContentLoaded", function() {
            console.log(@json($errors->all()));
            $('#navbarVerticalMenu').find('#staff-clearance-endorse-menu').addClass('active');
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="m-0 breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('staff.clearance.endorse.index') }}"
                                class="text-decoration-none text-dark">Endorse Staff
                                Clearance</a>
                        </li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <form action="{{ route('staff.clearance.endorse.store', $staffClearance->id) }}" id="editForm"
                                ...
                                <div class="col-lg-9">
                                    <select name="status_id" class="select2 form-control" data-width="100%">
                                        ...
                                        <option value="{{ config('constant.VERIFIED_STATUS') }}"
                                            ...
                                            Return</option>
                                        <option value="{{ config('constant.VERIFIED3_STATUS') }}"
                                            {{ old('status_id') == config('constant.VERIFIED3_STATUS') ? 'selected' : '' }}>
                                            Endorse</option>
                                    </select>
                            ...
                            <div class="mb-2 row" id="receiver">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-start h-100">
                                        <label for="approver_id" class="form-label required-label">Send To
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
