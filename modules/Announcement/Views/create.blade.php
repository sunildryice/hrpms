...
<div class="m-content p-3">
    <div class="container-fluid">
        ...
        <section>
            <form action="{{route('announcement.store')}}" method="POST" id="announcementCreateForm" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" type="text" name="published_date" id="published_date">
