...
class TransportationBillApproved extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject'=> 'Transportation bill '.$this->transportationRequest->getTransportationBillNumber().' has been approved.'
        ];
    }
