...
class TravelAuthorizationCancelRejected extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject'=> 'Cancellation for Travel Authorization request '.$this->travelAuthorization->getTravelAuthorizationNumber().' has been rejected.'
        ];
    }
