...
@section('title', 'Approve Fund Request')
...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function () {
            $('#navbarVerticalMenu').find('#approve-fund-requests-menu').addClass('active');
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            const form = document.getElementById('fundRequestApproveForm');
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('approve.fund.requests.index') }}" class="text-decoration-none">Fund
                                        Requests</a>
                                </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card shadow-sm border rounded mt-2">
                            ...
                            <form action="{{ route('approve.fund.requests.store', $fundRequest->id) }}"
                                  id="fundRequestApproveForm" method="post" enctype="multipart/form-data"
                                  autocomplete="off">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control"
                                                        ...
                                                        <option value="{{config('constant.SUBMITTED_STATUS')}}">Return to Checker</option>
                                                        <option value="{{config('constant.VERIFIED_STATUS')}}">Return to Certifier</option>
                                                        <option value="8">Reject</option>
                                                        {{-- @if($latestTenure->supervisor_id == $authUser->employee_id) --}}
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                    ...
                                    <a href="{!! route('approve.fund.requests.index') !!}"
