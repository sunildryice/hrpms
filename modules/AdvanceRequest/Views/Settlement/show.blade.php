...
@section('title', 'Settlement Advance Request Detail')
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                                            ...
                                            <table class="table table-bordered" id="expenseTable-{{ $expense->id }}">
                                                ...
                                                @foreach ($expense->details as $detail)
                                                    <tr id="detailRow-{{ $detail->id }}">
                                                        <td class="expense_date">
                                                            {{ $detail->getExpenseDate() }}</td>
                                                        <td class="bill_number">{{ $detail->bill_number }}
                                                        </td>
                                                        <td class="description">
                                                            {{ $detail->description }}</td>
                                                        <td class="gross_amount">
                                                            {{ $detail->gross_amount }}</td>
                                                        <td class="tax_amount">{{ $detail->tax_amount }}
                                                        </td>
                                                        <td class="net_amount">{{ $detail->net_amount }}
                                                        </td>
                                                        <td class="expense_type">
                                                            {{ $detail->getExpenseType() }}</td>
                                                        <td class="attachment">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="c-b">
                            @foreach ($advanceRequest->advanceSettlement->logs as $log)
