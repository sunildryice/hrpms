...
<form action="{{ route('profile.social-media.update', ['employee' => $employee->id]) }}" class="needs-validation"
        ...
        @foreach ($socialMediaAccounts as $account)
            ...
            <div class="col-lg-9 mt-2">
                <input type="text" class="form-control @if ($errors->has(strtolower($account->title))) is-invalid @endif"
                    ...
                    value="{{ old(strtolower($account->title), $socialMediaLinks[$account->title] ?? '') }}">
