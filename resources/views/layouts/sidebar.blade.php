                ...
                <div id="navbarVerticalMenu" class="nav nav-vertical card-navbar-nav nav-tabs flex-column">
                    ...
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle" href="#navbarEmployeeAttendance" role="button"
                           data-bs-toggle="collapse" data-bs-target="#navbarEmployeeAttendance" aria-expanded="false"
                           aria-controls="navbarEmployeeAttendance" data-bs-toggle="tooltip" data-bs-placement="right"
                           title="Attendance">
