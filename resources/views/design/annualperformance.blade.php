            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table class="table border">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4" >D.	KEY SKILLS EVALUATION (to be completed by supervisor)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                    ...
                    <table class="table border">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4" >F.	OVERALL PERFORMANCE EVALUATION (to be completed by supervisor)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th  scope="row">Substantially exceeds expectations:</th>
                                <td>Has mastered all job-related skills and consistently delivers outstanding results in all areas of responsibility</td>
                                <td>5</td>
                            </tr>
                            <tr>
                                <th  scope="row">Exceeds expectations</th>
                                <td>Highly skilled in relation to technical requirements of the job and regularly produces above-average results in all areas of responsibility.</td>
                                <td>4</td>
                            </tr>
                            <tr>
                                <th  scope="row">Meets all expectations</th>
                                <td>Is fully qualified to perform job duties with the appropriate amount of direction and regularly delivers expected results in all areas of responsibility.</td>
                                <td>3</td>
                            </tr>
                            <tr>
                                <th  scope="row">Partially meets expectations</th>
                                <td>Demonstrates beginner knowledge / skill level and does not yet consistently deliver expected results in all areas of responsibility.  Needs improvement.</td>
                                <td>2</td>
                            </tr>
                            <tr>
                                <th  scope="row">Below expectations</th>
                                <td>Demonstrates insufficient skills and does not deliver expected results in all areas of responsibility.  Significant and immediate improvement required.</td>
                                <td>1</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="table border">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4" >G.	IDENTIFY AT LEAST 3 KEY GOALS FOR THE NEXT REVIEW PERIOD: (To be completed jointly)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
