...
@section('page-content')
            ...
            <section class="registration">
                    <form action="{{ route('approved.purchase.requests.orders.update',[ $purchaseRequest->id, $purchaseOrder->id]) }}"
                        ...
                        <div class="justify-content-end d-flex gap-2">
                            ...
                            <a href="{!! route('approved.purchase.requests.orders.edit', [$purchaseRequest->id,$purchaseOrder->id]) !!}"
