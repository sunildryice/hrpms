...
@section('title', 'Approved Distribution Handover Detail')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function () {
            $('#navbarVerticalMenu').find('#approved-distribution-handovers-menu').addClass('active');
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('approved.distribution.requests.handovers.index') }}" class="text-decoration-none">Distribution
                                        Requests</a>
                                </li>
