...
class ConsolidatedFundRequestPrint implements Responsable, ShouldAutoSize, WithStyles, WithStrictNullComparison, FromView
{
    use Exportable;
    ...
    */
    private $fileName = 'consolidated_fund_request_report.pdf';
    ...
    */
    ...
    public function view(): View
    {
        ...
        $fundRequestActivities = FundRequestActivity::whereHas('fundRequest', function($q) use($year, $month) {
                                    $q->where('year', $year)
                                    ->where('month', $month)
                                    ->where('status_id', config('constant.APPROVED_STATUS'));
