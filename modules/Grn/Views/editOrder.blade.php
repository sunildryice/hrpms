    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function (e) {
            ...
            $('.received_date').datepicker({
                ...
                autoHide: true,
                format: 'yyyy-mm-dd',
                startDate: '{{ isset($grn->grnable->order_date) ? $grn->grnable->order_date->format('Y-m-d') : $grn->grnable->request_date->format('Y-m-d') }}',
                endDate: '{{ date('Y-m-d') }}',
            }).on('change', function () {
                    ...
                    <form action="{{ route('grns.update', $grn->id) }}"
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input readonly class="form-control" value="{!! $grn->getSupplierName() !!}"/>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                        ...
                        <div class="card-body">
                            <div class="card">
                                <div class="card-header fw-bold">
                                    ...
                                    <span>  Items</span>
                                <a class="btn btn-primary btn-sm text-capitalize" href="{!! route('grns.items.add.create', [$grn->id]) !!}">
