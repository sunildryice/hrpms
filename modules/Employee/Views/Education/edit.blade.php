<div class="card-header fw-bold">Edit Educational Details <span class="education_degree"></span></div>
<form class="needs-validation" action="{{ route('employees.education.update', ['employee', 'education']) }}"
