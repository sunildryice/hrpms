            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('employee.exits.index') }}"
                                class="text-decoration-none">Employee Exit</a></li>
                    ...
                    <form action="{{ route('employee.exits.update', $exitHandOverNote->id) }}"
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" data-width="100%" readonly
                                        value="{{ $exitHandOverNote->getEmployeeName() }}" />
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control datepicker" name="last_duty_date"
                                        value="{{ old('last_duty_date') ?: $exitHandOverNote->last_duty_date->format('Y-m-d') }}"
                                ...
                                <div class="col-lg-9">
                                    <div class=" form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            id="flexSwitchCheckChecked" name="is_insurance"
                                            @if($exitHandOverNote->is_insurance == 1) checked @endif>
