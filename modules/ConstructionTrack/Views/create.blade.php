                            ...
                            <form action="{{ route('construction.store') }}" id="constructionAddForm" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-3">
                                            <input
                                                class="form-control @if($errors->has('signed_date')) is-invalid @endif"
                                        ...
                                        <div class="col-lg-3">
                                            <input
                                                class="form-control @if($errors->has('nepali_date')) is-invalid @endif"
                                                type="text" readonly name="nepali_date"
                                                value="{{ old('nepali_date') }}"/>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-3">
                                            <input
                                                class="form-control @if($errors->has('type_of_work')) is-invalid @endif"
                                            ...
                                            <select name="local_level_id" class="select2 form-control"
                                                ...
                                                @foreach($localLevels as $local)
                                                    <option value="{{ $local->id }}" data-purchase="{{ $local->id }}"
                                                        {{ $local->id == old('local_level_id')? "selected":"" }}>
                                    ...
                                    {{-- <div class="row mb-2">
                                        ...
                                        <div class="col-lg-3">
                                           <select class="form-control select2 @if($errors->has('donor_codes')) is-invalid @endif" name="donor_codes[]" id="donor_codes" multiple>
                                               @foreach ($donors as $donor)
                                                   <option value="{{$donor->id}}">{{$donor->getDonorCodeWithDescription()}}</option>
                                               @endforeach
                                           </select>
                                        ...
                                        <div class="col-lg-3">
                                           <input type="text" class="form-control @if($errors->has('metal_plaque_text')) is-invalid @endif" name="metal_plaque_text" placeholder="Metal Plaque Text">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-3">
                                           <textarea class="form-control @if($errors->has('metal_plaque_text')) is-invalid @endif" placeholder="Metal Plaque Text"
                                            name="metal_plaque_text" id="metal_plaque_text" rows="2"></textarea>
                                            @if($errors->has('metal_plaque_text'))
                                                <div class="fv-plugins-message-container invalid-feedback">
                                                    <div data-field="metal_plaque_text">
                                                        {!! $errors->first('metal_plaque_text') !!}
