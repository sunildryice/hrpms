...
class ApprovedController extends Controller
{
    ...
    public function index(Request $request)
    {
        $authUser = auth()->user();
        if ($request->ajax()) {
            $data = $this->purchaseOrders->getApproved();
            ...
            return DataTables::of($data)
                ...
                ->addColumn('order_date', function ($row) {
                    ...
                    $btn .= route('approved.purchase.orders.show', $row->id) . '" rel="tooltip" title="View Purchase Order">';
        ...
        return view('PurchaseOrder::Approved.index');
    }
    ...
    public function show($purchaseOrderId)
    {
        ...
        return view('PurchaseOrder::Approved.show')
