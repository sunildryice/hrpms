...
class InstallmentReturned extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'              => route('construction.installment.submit.create', $this->installment->id),
            'subject'           => 'Construction installment has been returned.'
        ];
    }
}
