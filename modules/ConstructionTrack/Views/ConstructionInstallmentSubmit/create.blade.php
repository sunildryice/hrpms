...
@section('title', 'Submit Construction Installment')
...
<div class="m-content p-3">
    <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <input
                                        class="form-control @if ($errors->has('construction_year')) is-invalid @endif"
                                        type="year" name="construction_year"
                                        value="{{ old('construction_year')?: $construction->construction_year->format('Y') }}" />
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <select name="province_id" disabled class="select2 form-control" data-width="100%">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <select name="district_id" disabled class="select2 form-control" data-width="100%">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-start h-100">
                                        <label for="validationdd" class="form-label required-label">OHW Contribution
                                            Amount</label>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-3">
                                    <input type="hidden" name="engineer_id" id="engineer_id"
                                        value="{{$construction->engineer_id}}">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0 m-0">
                                    <div class="table-responsive">
                                        <table class="table" id="" style="margin: 0px !important">
                                            <thead class="thead-light">
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{$installment->advance_release_date->toFormattedDateString()}}
                                                    </td>
                                                    <td>{{$installment->remarks}}</td>
                                                    <td><span
                                                            class="{{$installment->getStatusClass()}}">{{$installment->getStatus()}}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        {{-- <div class="m-2 text-end">
                                            <span class="fw-bold">Total Sum of Installment: </span><span
                                                id="totalSumOfInstallment"></span>
                                        </div> --}}
                                    </div>
                                </div>
                            </div>
        ...
        <section>
            <div class="card">
                <div class="card-header fw-bold">
                    Construction Installment Submission
                </div>
                <form action="{{route('construction.installment.submit', $installment->id)}}"
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <div class="d-flex py-2 flex-row gap-2 mb-2 border-bottom ">
                                    ...
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <small title="{{$log->created_at}}">{{ $log->created_at->format('M d, Y h:i
                                                A') }}</small>
                                        </div>
                                ...
                                @if ($installment->status_id == config('constant.RETURNED_STATUS'))
                                    <div class="d-flex py-3 flex-row gap-3 mb-2 border-bottom">
                                        <div width="40" height="40" class="rounded-circle mr-3 user-icon">
                                        ...
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex flex-row align-items-center">
                                                    <span class="me-2">Remarks</span>
                                                </div>
                                                <small>{{ $installment->getLatestRemark()->created_at->diffForHumans() }}</small>
                                            </div>
                                            <p class="text-justify comment-text mb-0 mt-1">
                                                {{ $installment->getLatestRemark()->log_remarks }}
                                            </p>
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div class="col-lg-5">
                                <div class="d-flex py-2 flex-row gap-2 mb-2 border-bottom ">
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="col-lg-3">
                                                <div class="d-flex align-items-start h-100">
                                                    <label for="reviewer_id" class="form-label required-label">Submit
                                                        To</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-9">
                                ...
                                {{-- <div class="row mb-2">
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="reviewer_id" class="form-label required-label">Submit To</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-9">
                    ...
                    <div class="card-footer border-0 justify-content-end d-flex gap-2">
                        ...
                        <a href="{{ route('construction.settlement.edit', $construction->id) }}"
