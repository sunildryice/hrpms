...
@section('title', 'Approve Purchase Order Cancellation')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function () {
            $('#navbarVerticalMenu').find('#cancel-purchase-orders-menu').addClass('active');
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('approve.purchase.orders.cancel.index') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('approve.purchase.orders.cancel.store', $purchaseOrder->id) }}"
                                  id="purchaseOrderApproveForm" method="post"
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control"
                                                        ...
                                                        <option value="{{ config('constant.REJECTED_STATUS') }}">Reject Cancel Request</option>
                                                        <option value="{{ config('constant.CANCELLED_STATUS') }}">Cancel</option>
                                                    </select>
