...
@section('title', 'Verify Payment Sheet')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#verify-payment-sheets-menu').addClass('active');
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('paymentSheetApproveForm');
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('verify.payment.sheets.index') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('verify.payment.sheets.store', $paymentSheet->id) }}"
                                id="paymentSheetApproveForm" method="post" enctype="multipart/form-data"
                                autocomplete="off">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-5">
                ...
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            {{-- <div class="row mb-2">
                                                <div class="col-lg-3">
                                                    <div class="d-flex align-items-start h-100">
                                                        <label class="m-0" for="voucher_reference_number">Voucher No.</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-9">
                                                    <input class="form-control" type="text" name="voucher_reference_number" id="voucher_reference_number" value="{{old('voucher_reference_number')}}">
                                                    @if ($errors->has('voucher_reference_number'))
                                                        <div class="fv-plugins-message-container invalid-feedback">
                                                            <div data-field="voucher_reference_number">
                                                                {!! $errors->first('voucher_reference_number') !!}
                                                            </div>
                                                        </div>
                                                    @endif
                                                </div>
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                    ...
                                    <a href="{!! route('approve.payment.sheets.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
