...
@section('title', 'View Approved Transaction')
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="m-0 breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('mfr.transaction.approved.index', $transaction->agreement->id) }}" class="text-decoration-none text-dark">Approved Transactions                            </a>
                        </li>
