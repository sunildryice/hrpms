            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('profile.show')}}" class="text-decoration-none text-dark">Profile</a></li>
                        <li class="breadcrumb-item"><a href="{{route('attendance.show', $attendance->employee->id)}}" class="text-decoration-none text-dark">{{ __('label.attendance') }}</a></li>
                    ...
                    <tr>
                        ...
                        @foreach ($dates as $date)
                            ...
                            @else
                                @if ($date->get('leave'))
                                    <th>
                                        {{$date->get('leave')['leave_abbreviation']}}
                                    </th>
                                @else
        ...
        <div class="row my-3">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                            ...
                                            <span
                                                class="badge bg-primary c-badge">{!! $log->createdBy->employee->latestTenure->getDesignationName() !!}
                                            </span>
                                        </div>
