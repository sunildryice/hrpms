...
@section('title', 'Approve Payment Sheet')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approve-payment-sheets-menu').addClass('active');
                ...
                plugins: {
                    ...
                    excluded: new FormValidation.plugins.Excluded({
                        excluded: function(field, ele, eles) {
                            ...
                            return (field === 'approver_id' && statusId != "{{ config('constant.RECOMMENDED_STATUS') }}");
                        },
                    }),
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('approve.payment.sheets.index') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('approve.payment.sheets.store', $paymentSheet->id) }}"
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                        ...
                                        <div class="col-lg-7">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control" data-width="100%">
                                                        ...
                                                        @if($paymentSheet->status_id == config('constant.VERIFIED_STATUS'))
                                                            <option value="{{ config('constant.RECOMMENDED_STATUS') }}">Recommend</option>
                                                        @endif
                                            ...
                                            <div class="row mb-2" id="recommendBlock1" style="display: none;">
                                                <div class="col-lg-3">
                                                    <div class="d-flex align-items-start h-100">
                                            ...
                                            <div class="row mb-2" id="recommendBlock2" style="display: none;">
                                                <div class="col-lg-3">
                                                    <div class="d-flex align-items-start h-100">
