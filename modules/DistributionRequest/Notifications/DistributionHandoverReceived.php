...
class DistributionHandoverReceived extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject' => 'Distribution handover ' . $this->distributionHandover->getDistributionHandoverNumber() . ' has been received by ' . $this->distributionHandover->getReceiverName(),
        ];
    }
}
