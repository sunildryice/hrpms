...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#payrollBatchTable').on('click', '.delete-record', function(e) {
                e.preventDefault();
                $object = $(this);
        ...
        <div class="pb-3 mb-3 border-bottom">
            ...
            <div class="brd-crms flex-grow-1">
                ...
                <div class="add-info justify-content-end">
                    <a href="{{ route('payroll.batches.create') }}" class="btn btn-primary btn-sm">
                        <i class="bi-plus"></i> New Payroll Batch
                    </a>
                </div>
            </div>
