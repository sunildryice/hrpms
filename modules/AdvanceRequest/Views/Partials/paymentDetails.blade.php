        ...
        <ul class="list-unstyled list-py-2 text-dark mb-0">
            <li class="position-relative">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <div class="d-content-section"> {!! $advanceSettlementRequest->getPayerName() !!} </div>
                </div>
            ...
            <li class="position-relative">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <div class="d-content-section"> {!! $advanceSettlementRequest->getPaymentDate() !!} </div>
                </div>
            ...
            <li class="position-relative">
                <div class="d-flex gap-2 align-items-start">
                    ...
                    <div class="d-content-section"> {!! $advanceSettlementRequest->payment_remarks !!}</div>
                </div>
