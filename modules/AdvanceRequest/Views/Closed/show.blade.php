...
@section('title', 'Closed Advance Request Detail')
...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#navbarVerticalMenu').find('#closed-advance-requests-menu').addClass('active');
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('closed.advance.requests.index') }}"
                                        class="text-decoration-none text-dark">Closed Advance
                                        Requests</a>
                                </li>
