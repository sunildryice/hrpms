...
@section('page-content')
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('ta.requests.index') }}"
        ...
        <section class="registration">
            <div class="card">
                ...
                <form action="{{ route('ta.requests.store') }}" id="travelRequestAddForm" method="post"
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                <select name="travel_type_id" class="select2 form-control" data-width="100%">
                                    ...
                                    <option value="{{ $travelType->id }}" {{ $travelType->id ==
                                        old('travel_type_id')? "selected":"" }}>
                                        {{ $travelType->title }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                <select name="accompanying_staff[]" id="accompanying_staff"
                                    data-select2-id="accompanying_staff"
                                    class="@if($errors->has('accompanying_staff')) is-invalid @endif"
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="fv-plugins-message-container invalid-feedback">
                                    <div data-field="purpose_of_travel">{!! $errors->first('purpose_of_travel')
                                        !!}</div>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                <select name="project_code_id" class="select2 form-control
                                    ...
                                    <option value="{{ $project->id }}" {{$project->id == old('project_code_id')?
                                        "selected":""}}>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control
                                        @if($errors->has('departure_date')) is-invalid @endif" readonly
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control
                                        @if($errors->has('return_date')) is-invalid @endif" readonly
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                <select name="substitutes[]" id="substitutes"
                                    class="@if($errors->has('substitutes')) is-invalid @endif" data-width="100%"
                                    multiple>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="fv-plugins-message-container invalid-feedback">
                                    <div data-field="final_destination">{!! $errors->first('final_destination')
                                        !!}</div>
                                </div>
                                @endif
                            </div>
                    ...
                    <div class="card-footer border-0 justify-content-end d-flex gap-2">
                        ...
                        <a href="{!! route('ta.requests.create') !!}"
