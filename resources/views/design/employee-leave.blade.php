...
@section('page-content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="p-5 bg-danger mb-2 rounded">
                        ...
                        <div class="p-2">
                            <ul class="list-unstyled list-py-2 text-dark mb-0">
                                ...
                                <li class="position-relative"><i class="bi-person dropdown-item-icon"></i> Ram Bahadur
                                    Shrestha <a href="#" class="stretched-link" rel="tooltip" title="Profile"></a></li>
                                <li><i class="bi-briefcase dropdown-item-icon"></i> Finance</li>
                                ...
                                <li class="pt-4 pb-2"><span
                                        class="card-subtitle text-uppercase text-primary">Others</span></li>
                ...
                <div class="tabs-s mb-2">
                    <ul class="m-0 list-unstyled list-inline">
                        <li class="list-inline-item">
                            <a href="#" class="nav-link step-item active text-decoration-none" data-tag="generalinformantion">
                                <i class="nav-icon bi-info-circle"></i>Profile Inforamtion
                            </a>
                        </li>

                        <li class="list-inline-item"><a href="#" data-tag="tenure-details"
                                class="nav-link step-item text-decoration-none"><i class="nav-icon bi bi-person-workspace"></i>
                                Tenure</a></li>
                        <li class="list-inline-item"><a href="#" data-tag="tenure-details"
                                class="nav-link step-item text-decoration-none"><i class="nav-icon bi bi-person-workspace"></i>
                                Leave</a></li>
                        ...
                        <li class="list-inline-item"><a href="#" data-tag="tenure-details"
                                class="nav-link step-item text-decoration-none"><i class="nav-icon bi bi-vi"></i>
                                Travel</a></li>
                                <li class="list-inline-item"><a href="#" data-tag="tenure-details"
                                    class="nav-link step-item text-decoration-none"><i class="nav-icon bi bi-journal-text"></i>
                                    Education</a></li>
