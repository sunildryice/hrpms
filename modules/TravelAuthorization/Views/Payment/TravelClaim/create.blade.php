<div class="modal-header bg-primary text-white">
    <h5 class="modal-title mb-0 fs-6" id="openModalLabel">Payment Completion for
        {{ $travelClaim->travelAuthorization->getTravelAuthorizationNumber() }}</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form action="{!! route('approved.ta.claims.pay.store', $travelClaim->id) !!}" method="post" enctype="multipart/form-data" id="paymentForm" autocomplete="off">
