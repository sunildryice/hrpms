...
class ExitPayableApproved extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->greeting('Hello!')
            ->line('Employee Exit Payable for ' . $this->employeeExitPayable->getEmployeeName() . ' has been approved.')
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject' => 'Employee Exit Payable for ' . $this->employeeExitPayable->getEmployeeName() . ' has been approved.'
        ];
    }
}
