...
@section('title', 'Approve Construction Installment')

@section('page_js')
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function (e) {
            $('#navbarVerticalMenu').find('#construction-installment-approve').addClass('active');
        });
    ...
    <div class="container-fluid">
        ...
        <section>
            <div class="card">
                ...
                <form action="{{route('construction.installment.approve.store', $installment->id)}}"
                                    ...
                                    <div class="col-lg-9">
                                        <select name="status_id" class="select2 form-control" data-width="100%">
                                            ...
                                            <option value="{{ config('constant.RETURNED_STATUS') }}"
                                                {{old('status_id') == config('constant.RETURNED_STATUS') ? 'selected' : ''}}>Return to Employee</option>
                                            <option value="{{ config('constant.APPROVED_STATUS') }}"
                                                {{old('status_id') == config('constant.APPROVED_STATUS') ? 'selected' : ''}}>Approve</option>
                                        </select>
                    ...
                    <div class="card-footer border-0 justify-content-end d-flex gap-2">
                        ...
                        <a href="{{ route('construction.installment.approve.index') }}"
