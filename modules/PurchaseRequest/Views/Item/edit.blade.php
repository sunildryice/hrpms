...
<form action="{!! route('purchase.requests.items.update', [$purchaseRequestItem->purchase_request_id, $purchaseRequestItem->id]) !!}" method="post"
    ...
    <div class="modal-body">
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <textarea rows="5" class="form-control" name="specification">{{ $purchaseRequestItem->specification }}</textarea>
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <input type="number" class="form-control" name="quantity" value="{{ $purchaseRequestItem->quantity }}" placeholder="Quantity">
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-6">
                <input type="number" class="form-control" name="unit_price" value="{{ $purchaseRequestItem->unit_price }}" placeholder="Unit Price">
            </div>
            <div class="col-lg-3">
