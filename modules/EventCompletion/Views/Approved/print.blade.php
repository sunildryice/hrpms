            ...
            <div class="row">
                <div class="col-lg-12">
                    {{-- <table class="table border about-table mb-4">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">{{ $eventCompletion->getStartDate() }}</td>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-2">
                            <div class="d-flex align-items-start">
                                <label for="validationfullname" class="m-0 text-end flex-grow-1 fw-bold">Program Start Date:
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            {{ $eventCompletion->getStartDate() }}
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-2">
                            <div class="d-flex align-items-start">
                                <label for="validationfullname" class="m-0 text-end flex-grow-1 fw-bold">Program End Date:
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-5">

                            {{ $eventCompletion->getEndDate() }}
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10 text">{!! $eventCompletion->background !!}
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10 text">{!! $eventCompletion->objectives !!}
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10 text">{!! $eventCompletion->process !!}
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10 text">{!! $eventCompletion->closing !!}
                        </div>
                    </div>
                    ...
                    <table class="table border mb-4">
                        ...
                        <tbody>
                            @if ($eventCompletion->participants->isEmpty())
                                <tr>
