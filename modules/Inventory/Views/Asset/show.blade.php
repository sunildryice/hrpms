...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            const isDisposed = "{{ $disposition?->status_id == config('constant.APPROVED_STATUS') ? '1' : '0' }}";
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="m-0 breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{!! route('assets.index') !!}" class="text-decoration-none">Assets</a>
                                </li>
                            ...
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <span>
                                    <a href="{{ route('inventories.show', $inventory->id) }}" class="fs-7"
                                        title="View Inventory"><i class="bi bi-box-arrow-up-right"></i></a>
                                </span>
                            </div>
                            <div class="card-body">
                                <div class="p-1">
                                                    ...
                                                    <table class="table" id="assetTable">
                                                        <thead class="thead-light">
                                                            <tr>
                                                                ...
                                                                {{-- <th scope="col">{{ __('label.voucher-number') }}</th> --}}
                            ...
                            <div>
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        @if ($disposition?->status_id != config('constant.APPROVED_STATUS'))
                                            <a data-toggle="modal"
                                                class="btn btn-primary btn-sm open-asset-condition-log-modal-form"
                                                href="{{ route('asset.condition.logs.create', $asset->id) }}"
                                                rel="tooltip" title="Add Asset Condition">Add Condition</a>
                                        @endif
