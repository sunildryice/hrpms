        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="{!! route('training.requests.store') !!}" method="post" enctype="multipart/form-data" id="trainingAddForm"
                        autocomplete="off">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-start h-100">
                                        <label for="activitycode" class="form-label required-label">Name of Course(s) or
                                            Training requested
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="number" class="form-control" name="own_time" value=""
                                                    autofocus="" min=0 />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="number" class="form-control" name="work_time" value=""
                                                    autofocus="" min=0 />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" name="course_fee" class="form-control" id=""
                                        value="" min=0>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-start h-100">
                                        <label for="atvcde"
                                            class="form-label required-label">{{ __('label.activity-code') }}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-start h-100">
                                        <label for="acccde"
                                            class="form-label required-label">{{ __('label.account-code') }}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <textarea name="description" id="prblmdsc" cols="30" rows="5" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-start h-100">
                                        <label for="fileattch" class="form-label">Attach a copy of course(s)</label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                        ...
                        <div class="card-footer border-0 justify-content-end d-flex gap-2">
                            ...
                            <a href="{{ route('training.requests.index') }}" class="btn btn-danger btn-sm">Cancel</a>
                        </div>
                        {!! csrf_field() !!}
                    </form>
                </div>
