...
class ProbationaryReviewRequestReturned extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject'=> 'Probationary Review request for '.$this->probationaryReview->getReviewType().' has been returned. Please update your comment.'
        ];
    }
