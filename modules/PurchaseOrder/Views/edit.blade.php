                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <form action="{{ route('purchase.orders.update', $purchaseOrder->id) }}"
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        <div class="card-header fw-bold d-flex align-items-center add-info justify-content-between">
                                            <span>  Items</span>
                                            <button class="btn btn-primary btn-sm text-capitalize open-pr-modal-form" href="{!! route('purchase.orders.items.create', [$purchaseOrder->id]) !!}">
