...
class EventCompletionApproved extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->greeting('Hello!')
            ->line('Your Event Completion Report has been approved.')
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject'=> 'Event Completion Report of '.$this->eventCompletion->getStartDate(). ' to '. $this->eventCompletion->getEndDate().' has been approved',
        ];
    }
