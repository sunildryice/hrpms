...
@section('page-content')
    ...
    <section class="registration">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="card">
                    <form action="{!! route('training.requests.details.store', $trainingRequest->id) !!}" method="post" enctype="multipart/form-data"
                                        ...
                                        <select name="reviewer_id"
                                            ...
                                            @foreach ($reviewers as $reviewer)
                                                <option value="{{ $reviewer->id }}"
                                                    @if ($reviewer->id == $trainingRequest->reviewer_id) selected @endif>
                                            ...
                                            <select name="approver_id"
                                                ...
                                                @foreach ($approvers as $approver)
                                                    <option value="{{ $approver->id }}"
                                                        @if ($approver->id == $trainingRequest->approver_id) selected @endif>
                                            ...
                                            <select name="recommender_id"
                                                ...
                                                @foreach ($recommenders as $recommender)
                                                    <option value="{{ $recommender->id }}"
                                                        @if ($recommender->id == $trainingRequest->recommender_id) selected @endif>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label"
                                                    for="q3">{{ $trainingQuestion->question }}</label>
                        ...
                        <div class="card-footer border-0 justify-content-end d-flex gap-2">
                            <button type="submit" class="btn btn-primary" name="btn" value="save"
                                id="trainingDetailSave" data-submit = "save">Save</button>
