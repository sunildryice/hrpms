<div class="modal-header bg-primary text-white">
    <h5 class="modal-title mb-0 fs-6" id="openModalLabel">Add Details</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form id="ProjectActivityDetailForm" method="post"
    action="{{ route('project-activity.details.store', $projectActivity) }}" autocomplete="off">
    <div class="modal-body">
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <textarea name="key_accomplishment" class="form-control" rows="8"></textarea>
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <textarea name="challenge" class="form-control" rows="8"></textarea>
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <textarea name="lesson_learned" class="form-control" rows="8"></textarea>
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="saveDetailBtn">Save</button>
