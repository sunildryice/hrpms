...
<form id="ProjectActivityCreateForm" method="post"
    ...
    <div class="modal-body">
        ...
        <div class="row mb-2" id="budget_description-row">
            ...
            <div class="col-lg-9">
                <textarea name="budget_description" id="id-budget_description" class="form-control" rows="3" placeholder="Budget description"></textarea>
            </div>
        </div>
        ...
        <div class="row mb-2" id="deliverables-row">
            ...
            <div class="col-lg-9">
                <textarea name="deliverables" id="id-deliverables" class="form-control" rows="3" placeholder="Deliverables / Output"></textarea>
            </div>
        </div>
