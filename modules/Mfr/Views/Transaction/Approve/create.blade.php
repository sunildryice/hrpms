...
@section('title', 'Approve Transaction')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approve-transaction').addClass('active');
        });
    ...
    <section class="registration">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="{{ route('mfr.transaction.approve.store', $transaction->id) }}" id="travelClaimApproveForm"
