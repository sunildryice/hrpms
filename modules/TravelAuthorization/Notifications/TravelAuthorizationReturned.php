...
class TravelAuthorizationReturned extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'=>route('ta.requests.edit', $this->travelAuthorization->id),
            'alternate_link'=>route('ta.requests.view', $this->travelAuthorization->id),
            'subject'=> 'Travel Authorization request '.$this->travelAuthorization->getTravelAuthorizationNumber().' has been returned.'
        ];
    }
