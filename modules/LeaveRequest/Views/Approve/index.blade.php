    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var oTable = $('#leaveRequestTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('approve.leave.requests.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Approve Leave Requests</li>
                        </ol>
                    </nav>
                    <h4 class="m-0 lh1 mt-1 fs-6 text-uppercase fw-bold">Approve Leave Requests</h4>
                </div>
            </div>
