...
@section('page_js')
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            const form = document.getElementById('leaveRequestApproveForm');
    ...
    <div class="m-content p-3">
        <div class="container-fluid">
            ...
            <section class="registration">
                <div class="row">
                    <div class="col-lg-3">
                        @include('LeaveRequest::Partials.detail')
                    </div>
                    <div class="col-lg-9">
                        <div class="card">
                            ...
                            <form action="{{ route('approve.leave.requests.store', $leaveRequest->id) }}"
                                  id="leaveRequestApproveForm" method="post"
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control"
                                                        ...
                                                        @if($executiveDirectorflag)
                                                            <option value="6">Approve</option>
                                                        @elseif ($leaveDays > 3 && $leaveRequest->requester->employee->latestTenure->supervisor_id == auth()->user()->employee_id)
