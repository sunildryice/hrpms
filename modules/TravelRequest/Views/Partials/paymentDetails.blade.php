        ...
        <ul class="list-unstyled list-py-2 text-dark mb-0">
            <li class="position-relative">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <div class="d-content-section"> {!! $travelClaim->getPayerName() !!} </div>
                </div>
            ...
            <li class="position-relative">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <div class="d-content-section"> {!! $travelClaim->getPaymentDate() !!} </div>
                </div>
            ...
            <li class="position-relative">
                <div class="d-flex gap-2 align-items-start">
                    ...
                    <div class="d-content-section"> {!! $travelClaim->payment_remarks !!}</div>
                </div>
