                ...
                $('#delegationAddForm').formValidation({
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $(rowTr).addClass('gradeX').attr('id', 'row_' + response
                                .delegation.id);
            ...
            $('#delegation-table').on('click', '.deactivate', function(e) {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            swal('Success', response.message, 'success');
                            $('#tablebody').find('#row_' + response.delegation.id).find(
                                '.end_date').text(response.delegation.end_date);
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="adv-table editable-table ">
                        <div class="btn-group">
                            <a data-toggle="modal" href="{!! route('authority.delegation.create') !!}" class="btn btn-primary btn-lg"
