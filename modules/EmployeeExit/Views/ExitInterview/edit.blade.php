                ...
                <div class="col-lg-3">
                    <div class="pt-3 pb-3 bg-white rounded border shadow-sm vertical-navigation sm-menu-vr">
                        <ul class="m-0 list-unstyled">
                            <li class="nav-item"><a
                                    href="@if ($authUser->can('update', $exitHandOverNote)) {{ route('exit.employee.handover.note.edit') }}
                                          @else
                                    ...
                                    @foreach ($exitInterviewQuestionAnswers as $answer)
                                        <div class="mb-3 row">
                                            @if ($answer->exitQuestionsAnswer->answer_type == 'textarea')
                                                <div class="col-lg-3">
                                                    <label
                                                        for="">{{ $answer->exitQuestionsAnswer->question }}</label>
                                                </div>
                                                <div class="col-lg-9">
                                                    <textarea rows="3" class="form-control @if ($errors->has('textarea.{{ $answer->question_id }}')) is-invalid @endif"
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="boolean[{{ $answer['question_id'] }}]"
                                                                id="inlineRadio1" value="on"
                                                                @if (old('boolean.' . $answer->question_id) == 'on') checked @endif>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                @if ((old('boolean.' . $answer->question_id) ?? $answer['answer']) == 'off') checked @endif>
                                            ...
                                            @else
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    @foreach ($checkboxOption as $val)
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="checkbox[{{ $answer['question_id'] }}]"
                                                                id="inlineRadio1" value="{{ $val }}"
                                                                @if ((old('checkbox' . $answer->question_id) ?? $answer->answer) == $val) checked @endif>
                                                            <label class="form-check-label"
                                                                for="inlineRadio1">{{ $val }}</label>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endif
                                    ...
                                    @foreach ($exitQuestions as $question)
                                        <div class="mb-3 row">
                                            ...
                                            @if ($question->answer_type == 'textarea')
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea rows="3" class="form-control @if ($errors->has('textarea.{{ $question->id }}')) is-invalid @endif"
                                            ...
                                            @elseif($question->answer_type == 'boolean')
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="boolean[{{ $question['id'] }}]" id="inlineRadio1"
                                                            value="on"
                                                            @if (old('boolean.' . $question->id) == 'on') checked @endif>
                                                        <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="boolean[{{ $question['id'] }}]" id="inlineRadio2"
                                                            value="off"
                                                            @if (old('boolean.' . $question->id) == 'off') checked @endif>
                                                    ...
                                                    @foreach ($checkboxOption as $val)
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                id="inlineRadio-{{ $val }}"
                                                                value="{{ $val }}"
                                                                @if (old('checkbox.' . $question->id) == $val) checked @endif>
                                                            <label class="form-check-label"
                                                                for="inlineRadio-{{ $val }}">{{ $val }}</label>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endif
                                ...
                                @if (count($exitInterviewFeedbackAnswers))
                                    @foreach ($exitInterviewFeedbackAnswers as $exitInterviewFeedbackAnswer)
                                        <div class="mb-3 row">
                                            <div class="col-lg-6">
                                                <label
                                                    for="">{{ $exitInterviewFeedbackAnswer->exitFeedback['title'] }}</label>
                                            </div>
                                            <div class="col-lg-6">
                                                <select class="select2 form-control"
                                                    ...
                                                    <option value="always"
                                                        {{ $exitInterviewFeedbackAnswer->always == 1 ? 'selected' : '' }}>
                                                        Always
                                                    </option>
                                                    <option value="almost"
                                                        {{ $exitInterviewFeedbackAnswer->almost == 1 ? 'selected' : '' }}>
                                                        Almost
                                                    </option>
                                                    <option value="usually"
                                                        {{ $exitInterviewFeedbackAnswer->usually == 1 ? 'selected' : '' }}>
                                                        Usually
                                                    </option>
                                                    <option value="sometimes"
                                                        {{ $exitInterviewFeedbackAnswer->sometimes == 1 ? 'selected' : '' }}>
                                                        Sometimes
                                                    </option>
                                                </select>
                                            </div>
                                ...
                                @if (count($exitInterviewFeedbackAnswers))
                                    @foreach ($exitInterviewRatingAnswers as $exitInterviewRatingAnswer)
                                        <div class="mb-3 row">
                                            <div class="col-lg-6">
                                                <label
                                                    for="">{{ $exitInterviewRatingAnswer->exitRating['title'] }}</label>
                                            </div>
                                            <div class="col-lg-6">
                                                <select class="select2 form-control"
                                                    ...
                                                    <option value="excellent"
                                                        {{ $exitInterviewRatingAnswer->excellent == 1 ? 'selected' : '' }}>
                                                        Excellent
                                                    </option>
                                                    <option value="good"
                                                        {{ $exitInterviewRatingAnswer->good == 1 ? 'selected' : '' }}>
                                                        Good
                                                    </option>
                                                    <option value="fair"
                                                        {{ $exitInterviewRatingAnswer->fair == 1 ? 'selected' : '' }}>
                                                        Fair
                                                    </option>
                                                    <option value="poor"
                                                        {{ $exitInterviewRatingAnswer->poor == 1 ? 'selected' : '' }}>
                                                        Poor
                                                    </option>
                                                </select>
                                ...
                                @else
                                    @foreach ($exitRatings as $exitRate)
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="select2 form-control"
                                                    name="ratingAnswers[{{ $exitRate->id }}]">
                                                    <option value="">Select Rating</option>
