...
class LeaveEncashLog extends Model
{
     ...
     * @var string
     */
    protected $table = 'leave_encash_logs';
    ...
    /**
     * Get the leave encash of the log.
     */
    public function leaveEncash()
    {
        return $this->belongsTo(LeaveEncash::class, 'leave_encash_id');
    }
