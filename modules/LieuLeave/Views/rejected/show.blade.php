...
@section('title', 'Rejected Lieu Leave Request Detail')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#rejected-lieu-leave-requests-index').addClass('active');
        });
    </script>
@endsection
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('rejected.lieu.leave.requests.index') }}"
