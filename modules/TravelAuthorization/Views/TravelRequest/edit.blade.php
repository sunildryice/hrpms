...
<form action="{{ route('ta.requests.update', $travel->id) }}" id="travelRequestEditForm" method="post"
                ...
                <select name="travel_type_id" class="select2 form-control" data-width="100%">
                    ...
                    @foreach($travelTypes as $travelType)
                        <option value="{{ $travelType->id }}"
                            {{ $travelType->id == $travel->travel_type_id? "selected":"" }}>
                            {{ $travelType->title }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <input type="text"
                        ...
                        value="{{ $travel->purpose_of_travel }}"
            ...
            <div class="col-lg-9">
                <select name="project_code_id" class="select2 form-control
                    ...
                    @foreach($projects as $project)
                        <option value="{{ $project->id }}" {{ $project->id == $travel->project_code_id? "selected":"" }}>
                            {{ $project->title }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-lg-9">
                <select name="substitute_id" class="select2 form-control
                    ...
                    @foreach($substitutes as $substitute)
                        <option value="{{ $substitute->id }}" {{$substitute->id == $travel->substitute_id? "selected":""}}>
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control
                    @if($errors->has('departure_date')) is-invalid @endif"
                        name="departure_date" value="{{ $travel->departure_date }}" data-toggle="datepicker"/>
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control
                    @if($errors->has('return_date')) is-invalid @endif"
                        name="return_date" value="{{ $travel->return_date }}" data-toggle="datepicker"/>
                {{-- <input type="hidden" value="{{ date('Y-m-d') }}" name="today"
                        class="form-control"/> --}}
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <textarea type="text"
                        ...
                        name="remarks">@if($travel->remarks){{ $travel->remarks }}@endif</textarea>
