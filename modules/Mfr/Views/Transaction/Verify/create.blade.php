...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#verify-transaction').addClass('active');
        });
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
                    ...
                    excluded: new FormValidation.plugins.Excluded({
                        excluded: function(field, ele, eles) {
                            const statusId = parseInt(form.querySelector('[name="status_id"]')
                                .value);
                            return (field === 'recommender_id' && statusId !== 14) || (field ===
            ...
            }).on('change', '[name="recommender_id"]', function(e) {
                fv.revalidateField('recommender_id');
            });
        });
    </script>
@endsection
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="m-0 breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('mfr.transaction.verify.index') }}"
                                class="text-decoration-none text-dark">Verify Transaction
                            </a>
                        </li>
    ...
    <section class="registration">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="{{ route('mfr.transaction.verify.store', $transaction->id) }}" id="travelClaimApproveForm"
                    ...
                    <div class="card">
                            ...
                            <div class="pt-4 border-top">
                                ...
                                <div class="mb-2 row" id="recommendBlock" style="display: none;">
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="validationleavetype"
                                                class="form-label required-label">Recommender</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-9">
                                        <select name="recommender_id" class="select2 form-control" data-width="100%">
                                            <option value="">Select a Recommender</option>
                                            @foreach ($recommenders as $approver)
                        ...
                        <div class="gap-2 card-footer border-top justify-content-end d-flex">
                            ...
                            <a href="{!! route('mfr.transaction.verify.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
