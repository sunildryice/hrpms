...
@section('title', 'Fund Request Detail')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approved-fund-requests-menu').addClass('active');
        });
    </script>
@endsection
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('fund.requests.index') }}" class="text-decoration-none">Fund
                                        Requests</a>
                                </li>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-footer bg-white">
                                <a href="{{ route('approved.fund.requests.print', $fundRequest->id) }}" target="_blank"
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        @include('FundRequest::Partials.fund-request-activities')
                                    </div>
                                </div>
                            </div>
                        </div>
