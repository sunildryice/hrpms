...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('attendance_master_logs', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('attendance_master_id')->references('id')->on('attendance_masters');
    ...
    {
        Schema::dropIfExists('attendance_master_logs');
    }
};
