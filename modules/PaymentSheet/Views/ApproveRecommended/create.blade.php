...
@section('title', 'Approve Recommended Payment Sheet')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approve-recommended-payment-sheets-menu').addClass('active');
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('approve.recommended.payment.sheets.index') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('approve.recommended.payment.sheets.store', $paymentSheet->id) }}"
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                    ...
                                    <a href="{!! route('approve.recommended.payment.sheets.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
