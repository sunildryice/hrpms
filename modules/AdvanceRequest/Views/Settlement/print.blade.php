...
@section('page-content')
            ...
            <div class="col-lg-8">
                ...
                <div class="print-header-info mb-3 mt-5 pt-5">
                    <ul class="list-unstyled m-0 p-0 fs-7">
                        <li><span
                                class="fw-bold me-2"> Staff Name :</span><span>{{ $settlement->getRequesterName() }}</span>
                        </li>
                        <li><span
                                class="fw-bold me-2"> Title :</span><span>{{ $settlement->requester->employee->getDesignationName()}}</span>
                        </li>
                        <li><span
                                class="fw-bold me-2">Original Advance Issue Date :</span><span>{{ $settlement->advanceRequest->getApprovedDate() }}</span>
                        </li>
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column justify-content-end">
                    ...
                    <ul class="list-unstyled m-0 p-0 fs-7 align-self-end">
                        <li><span
                                class="fw-bold me-2">Ref # :</span><span>{{$settlement->advanceRequest->getAdvanceRequestNumber()}}</span>
                        </li>
                        <li><span
                                class="fw-bold me-2">Program Completion Date :</span><span>{{$settlement->getCompletionDate()}}</span>
                        </li>
                        <li><span
                                class="fw-bold me-2">Program Settlement Date :</span><span>{{ $settlement->getApprovedDate() }}</span>
                        </li>
                        <li><span class="fw-bold me-2">Total days:</span><span> {{ $settlement->getTotalTurnAroundDays() }} </span></li>
    ...
    <div class="print-body ">
        ...
        <p class="mb-4">Reason for over/underspending and agreed by approver :
            <span>{{ $settlement->reason_for_over_or_under_spending }}</span></p>
    </div>
