...
@section('title', __('label.activity-codes'))

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#activity-codes-menu').addClass('active');

            var oTable = $('#activityCodeTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.activity.codes.index') }}",
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
            ...
            $('#activityCodeTable').on('click', '.delete-record', function(e) {
                e.preventDefault();
                $object = $(this);
            ...
            $(document).on('click', '.open-activity-modal-form', function(e) {
                ...
                $('#openModal').modal('show').find('.modal-content').load($(this).attr('href'), function (){
                    const form = document.getElementById('activityCodeForm');
            ...
            <div class="brd-crms flex-grow-1">
                ...
                <div class="add-info justify-content-end">
                    <button data-toggle="modal" class="btn btn-primary btn-sm open-activity-modal-form"
                        href="{!! route('master.activity.codes.create') !!}">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="activityCodeTable">
