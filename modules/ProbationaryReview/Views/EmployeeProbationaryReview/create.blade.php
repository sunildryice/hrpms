...
@section('page_js')
    <script>
        ...
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#employee-probation-review-menu').addClass('active');
        });
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('employeeProbationReviewAddForm');
            const fv = FormValidation.formValidation(form, {
                fields: {
                    employee_remarks: {
                        validators: {
                            notEmpty: {
                                message: 'Employee Remarks is required',
                            },
                        },
                    },
                },
            ...
            <section class="registration">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if($probationaryReview->director_recommendation != NULL)
                        <div class="row mb-3">
                        ...
                        @if($authUser->can('employeeRemarks', $probationaryReview))
                            <form action="{!! route('employeeProbation.review.detail.requests.store', $probationaryReview->id) !!}" method="post"
                                enctype="multipart/form-data" id="employeeProbationReviewAddForm" autocomplete="off">
                                {!! csrf_field() !!}

                                <div class="row mb-3">
                                    <label for="">{{ __('label.employee-comments') }}</label>
                                    <div class="mt-2">
                                        <textarea rows="5" class="form-control @if($errors->has('employee_remarks')) is-invalid @endif"
                                                  name="employee_remarks">{!! old('employee_remarks') ?: $probationaryReview->employee_remarks !!}</textarea>
                                    </div>
                                    @if ($errors->has('employee_remarks'))
                                        <div class="fv-plugins-message-container invalid-feedback">
                                            <div data-field="employee_remarks">
                                                {!! $errors->first('employee_remarks') !!}
                                            </div>
                                        </div>
                                    @endif
                                </div>
