                        ...
                        <form action="{{ route('inventories.store') }}" id="inventoryForm" method="post"
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="office_id"
                                            ...
                                            @foreach ($offices as $office)
                                                <option value="{{ $office->id }}" @if ($office->id == old('office_id'))
                                    ...
                                    <div class="col-lg-9">
                                        <select name="supplier_id" class="select2 form-control" data-width="100%">
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}" @if ($supplier->id == old('supplier_id'))
                                                selected="selected" @endif>
                                    ...
                                    <div class="col-lg-9">
                                        <select name="item_id" class="select2 form-control" data-width="100%">
                                            ...
                                            @foreach ($items as $item)
                                                <option value="{{ $item->id }}" @if ($item->id == old('item_id'))
                                                selected="selected" @endif>
                                                    {{ $item->getItemName() }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="col-lg-9">
                                        <div class=" form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                id="flexSwitchCheckChecked" name="vat_applicable" @if (old('vat_applicable')) checked @endif>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9">
                                        <input class="form-control @if ($errors->has('expiry_date')) is-invalid @endif"
                                            type="text" readonly name="expiry_date" value="{{ old('expiry_date') }}" />
                                ...
                                {{-- <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control select2" data-width="100%" name="activity_code_id">
                                            ...
                                            <option value="{!! $activityCode->id !!}" @if ($activityCode->id ==
                                                old('activity_code_id')) selected="selected" @endif>{{
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control select2" data-width="100%" name="donor_code_id">
                                            ...
                                            <option value="{!! $donorCode->id !!}" @if ($donorCode->id ==
                                                old('donor_code_id')) selected="selected" @endif>{{
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control select2" data-width="100%"
                                            ...
                                            @foreach ($distributionTypes as $distributionType)
                                                <option value="{!! $distributionType->id !!}" @if ($distributionType->id == old('distribution_type_id')) selected="selected"
                                                @endif>
                                                    {{ $distributionType->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea class="form-control" name="specification" id="specification"
                                            rows="2">{{ old('specification') }}</textarea>
