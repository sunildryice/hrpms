...
@section('page_js')
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            const form = document.getElementById('dispositionRequestApproveForm');
...
@endsection
@section('page-content') <div class="m-content p-3">
                ...
                <div class="brd-crms flex-grow-1">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('approve.asset.disposition.index') }}" class="text-decoration-none">Approve Asset Disposition</a>
                            </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                            ...
                            <table class="table" id="travelRecommendationTable">
                                ...
                                <tbody>
                                    @forelse($dispositionRequest->disposeAssets as $index=>$asset)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $asset->getAssetNumber() }}&emsp;<a href="{{route('assets.show',$asset->asset_id)}}" target="_blank" rel="noopener noreferrer"><i class="bi bi-box-arrow-up-right"></i></a> </td>
                    ...
                    <div class="card">
                        ...
                        <form action="{{ route('approve.asset.disposition.store', $dispositionRequest->id) }}"
                              id="dispositionRequestApproveForm" method="post"
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
            <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-md-2 mb-2 mb-md-0">
                            ...
                            <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                ...
                                <a href="{!! route('approve.asset.disposition.index') !!}"
