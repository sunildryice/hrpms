...
@section('title', 'Closed Purchase Requests')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var oTable = $('#purchaseRequestTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('closed.purchase.requests.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $(document).on('click', '.open-pr', function() {
                ...
                ajaxTextSweetAlert(url, 'POST', `Re-open ${number}?`, 'Remarks',
                    'open_remarks', successCallback);
            });


            $('#purchaseRequestTable').on('click', '.close-purchase-request', function(e) {
                e.preventDefault();
                $object = $(this);
                ...
                var confirmText = 'Close this purchase request'
                ajaxSweetAlert($url, 'PUT', {}, confirmText, successCallback);
            });
