...
@section('title', 'Approve Travel Claim')
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('approve.travel.claims.index') }}"
    ...
    <section class="registration">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="{{ route('approve.travel.claims.store', $travelClaim->id) }}" id="travelClaimApproveForm"
                    ...
                    <div class="card">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="status_id" class="select2 form-control" data-width="100%">
                                            ...
                                            @if ($travelClaim->status_id != 5)
                                                <option value="5">Recommend</option>
                                            @endif
                        ...
                        <div class="card-footer border-top justify-content-end d-flex gap-2">
                            <button type="submit" name="btn" value="submit" class="btn btn-success btn-sm">
                                Submit
                            </button>
                            <a href="{!! route('approve.travel.claims.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
