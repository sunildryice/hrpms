...
@section('title', 'Approved Settlement Advance Request Detail')
...
@section('page_js')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approved-advance-settlement-menu').addClass('active');
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('approved.advance.settlements.index') }}"
                                class="text-decoration-none text-dark">Approved Advance Settlement
                                Requests</a>
                        </li>
