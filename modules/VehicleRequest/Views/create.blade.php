            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="card c-tabs-content" id="office-vehicle">
                        ...
                        <form action="{{ route('vehicle.requests.store') }}" id="officeVehicleRequestAddForm"
                              method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-3">
                                        <div class="d-flex align-items-start h-100">
                                            <label for="validationfullname" class="form-label required-label">Vehicle Type</label>
                                        </div>
                                        ...
                                        <select
                                            ...
                                            @foreach($vehicleTypes as $vehicleType)
                                                <option value="{{ $vehicleType->id }}"
                                                        @if(old('vehicle_type_id') == $vehicleType->id) selected @endif>{{ $vehicleType->title }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mb-2">
                                                <div class="input-group">
                                                    ...
                                                    <input data-toggle="datepicker-time" type="text" name="office_start_datetime"
                                                        value="{!! old('office_start_datetime') !!}"
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input data-toggle="datepicker-time" type="text" name="office_end_datetime"
                                                        value="{!! old('office_end_datetime') !!}"
                                    ...
                                    <div class="col-lg-9">
                                        <select name="employee_ids[]"
                                            ...
                                            @foreach($employees as $employee)
                                                <option
                                                    value="{{ $employee->id }}" @if(old('employee_ids') && in_array($employee->id, old('employee_ids')))selected @endif>{{ $employee->getFullNameWithCode() }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-9">
                                        <select name="approver_id"
                                            ...
                                            @foreach($approvers as $approver)
                                                <option value="{{ $approver->id }}" @if($approver->id == old('approver_id')) selected="selected" @endif>
                    ...
                    <div class="card c-tabs-content" id="hire-vehicle">
                        ...
                        <form action="{{ route('vehicle.requests.store') }}" id="hireVehicleRequestAddForm"
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" data-toggle="datepicker-range" value="{{ old('start_end_datetime') }}"
                                               class="form-control @if($errors->has('start_end_datetime')) is-invalid @endif"
                                               name="start_end_datetime">
                                        <input type="hidden" class="form-control" name="start_datetime" value="{{ old('start_datetime') ?: date('Y-m-d') }}">
                                        <input type="hidden" class="form-control" name="end_datetime" value="{{ old('end_datetime') ?: date('Y-m-d') }}">
                                                ...
                                                <div class="col-lg-4">
                                                    <span
                                                        ...
                                                        <span class="filter-body">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <span class="">Others</span>
                                                                <input type="text" name="for_hours_other_remarks" class="form-control">
                                                            </div>
                                                        </span>
                                                    </span>
                                                </div>
