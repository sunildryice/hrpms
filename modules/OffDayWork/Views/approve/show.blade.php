...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approve-off-day-work-approve').addClass('active');
        });
    </script>
@endsection
            ...
            <div class="col-lg-8">
                ...
                @can('approve-work-from-home')
                    <div class="card">
                        ...
                        <form action="{{ route('approve.off.day.work.update', $offDayWork->id) }}" id="offDayWorkApproveForm"
