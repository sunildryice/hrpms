...
@section('title', 'Review Advance Settlement Request')
...
@section('page_js')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#review-settlement-advance-requests-menu').addClass('active');
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('advanceRequestReviewForm');
            const fv = FormValidation.formValidation(form, {
                fields: {
                    ...
                    verifier_id: {
                        validators: {
                            notEmpty: {
                                message: 'Second level verifier is required.',
                            },
                        },
                    },
                    log_remarks: {
                ...
                plugins: {
                    ...
                    excluded: new FormValidation.plugins.Excluded({
                        excluded: function (field, ele, eles) {
                            ...
                            $verifiers = "{{$verifiers}}";
                            return ($verifiers == "") || (field === 'verifier_id' && statusId !== 11) || (field === 'status_id' && statusId === 11);
                        },
                    }),
            ...
            $(form).on('change', '[name="status_id"]', function (e) {
                fv.revalidateField('status_id');
                if (this.value == "{{config('constant.VERIFIED_STATUS')}}") {
                    $verifiers = "{{$verifiers}}";
                    if ($verifiers) {
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('review.advance.settlements.index') }}"
                                        class="text-decoration-none text-dark">Advance
                                        Request Settlements</a>
                                </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('review.advance.settlements.store', $advanceSettlementRequest->id) }}"
                                id="advanceRequestReviewForm" method="post" enctype="multipart/form-data"
                                autocomplete="off">
                                <div class="card-body">
                                        <div class="c-b">
                                        ...
                                        <div class="border-top pt-4">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control" data-width="100%">
                                                        ...
                                                        <option value="{{config('constant.VERIFIED_STATUS')}}">Verified</option>
                                                    </select>
                                            ...
                                            <div class="row mb-2" id="recommendBlock" style="display: none;">
                                                <div class="col-lg-3">
                                                    <div class="d-flex align-items-start h-100">
                                                        <label for="verifier_id"
                                                               class="m-0">Recommend To*</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-9">
                                                    <select name="verifier_id" class="select2 form-control"
                                                            data-width="100%">
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                        ...
                                        <a href="{!! route('review.advance.settlements.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
