...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('leave_encash_requests', function (Blueprint $table) {
            $table->id();
            ...
            $table->double('available_balance', 6, 2)->nullable()->default(null);
            $table->double('encash_balance', 6, 2)->nullable()->default(null);
            $table->string('prefix')->nullable()->default(null);
            $table->unsignedInteger('encash_number')->nullable()->default(null);
            $table->unsignedInteger('modification_number')->nullable()->default(null);
            $table->unsignedBigInteger('modification_leave_encash_id')->nullable()->default(null);
            $table->date('request_date');
            $table->text('remarks')->nullable()->default(null);
            $table->unsignedBigInteger('status_id')->nullable()->default(null);
            $table->date('pay_date')->default(null)->nullable();
            $table->dateTime('paid_at')->default(null)->nullable();
            $table->longText('payment_remarks')->default(null)->nullable();
    ...
    {
        Schema::dropIfExists('leave_encash_requests');
    }
};
