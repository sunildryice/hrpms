        ...
        <table class="table border">
            <tbody>
                ...
                <tr>
                    ...
                    <td>@if($probationaryReview->review_id == 1){{$probationaryReview->getReviewDate()}}@endif</td>
                    <td></td>
                </tr>
                <tr>
                    <td>3-month review:</td>
                    <td>@if($probationaryReview->review_id == 2){{$probationaryReview->getReviewDate()}}@endif</td>
                    <td></td>
                </tr>
                <tr>
                    <td>6-month review:</td>
                    <td>@if($probationaryReview->review_id == 3){{$probationaryReview->getReviewDate()}}@endif</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                @foreach($probationaryReviewIndicators as $probationaryReviewIndicator)
                    <tr>
                        ...
                        <td>@if($probationaryReviewIndicator->improved_required == 1) <i class="bi bi-check"></i> @endif</td>
                        <td>@if($probationaryReviewIndicator->satisfactory == 1) <i class="bi bi-check"></i> @endif</td>
                        <td>@if($probationaryReviewIndicator->good == 1) <i class="bi bi-check"></i> @endif</td>
                        <td>@if($probationaryReviewIndicator->excellent == 1) <i class="bi bi-check"></i> @endif</td>
                    </tr>
                @endforeach
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        Yes @if($probationaryReview->objectives_met == 1) <i class="bi bi-check"></i> @endif<br>
                        No @if($probationaryReview->objectives_met == 0) <i class="bi bi-check"></i> @endif
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        Yes @if($probationaryReview->development_addressed == 1) <i class="bi bi-check"></i> @endif<br>
                        No @if($probationaryReview->development_addressed == 0) <i class="bi bi-check"></i> @endif
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="4">Date: {{@array_key_exists('recommended_date', $dates)? $dates['recommended_date']:''}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        Yes @if($probationaryReview->appointment_confirmed == 1) <i class="bi bi-check"></i> @endif<br>
                        No @if($probationaryReview->appointment_confirmed == 0) <i class="bi bi-check"></i> @endif
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="content" colspan="5">@if($probationaryReview->appointment_confirmed == 0){{$probationaryReview->reason_to_address_difficulty}}@endif</td>
                </tr>
                <tr>
                    <td colspan="5">The employee may provide any comments about their experience of the probationary process here.</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        Yes @if($probationaryReview->probation_extended == 1) <i class="bi bi-check"></i> @endif <br>
                        No @if($probationaryReview->probation_extended == 0) <i class="bi bi-check"></i> @endif
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="content" colspan="5">@if($probationaryReview->probation_extended == 1){{ $probationaryReview->reason_and_improvement_to_extend}}@endif</td>
                </tr>
                <tr>
                    <td>Length of the extension (max 3 months):</td>
                    <td colspan="4">@if($probationaryReview->probation_extended == 1){{ $probationaryReview->extension_length}}@endif</td>
                </tr>
                <tr>
                    <td>New Probation Period completion date:</td>
                    <td colspan="4">@if($probationaryReview->probation_extended == 1){{date('Y-m-d', strtotime($probationaryReview->next_probation_complete_date))}}@endif</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="4">{{@array_key_exists('recommended_date', $dates)? $dates['recommended_date']:''}}</td>
                </tr>
                <tr>
                    <td>Approved Date:</td>
