...
class ApprovedController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $authUser = auth()->user();
                    $btn = '<a href="' . route('approved.off.day.work.show', $row->id) . '" class="btn btn-sm btn-primary">
                    <i class="bi bi-eye"></i> 
                    </a>';
                    return $btn;
                })
        ...
        return view('OffDayWork::approved.index');
    }
    ...
    public function show($offDayWork)
    {
        ...
        return view('OffDayWork::approved.show', compact('offDayWork', 'deliverables'));
    }
}
