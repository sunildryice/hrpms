    ...
    <div class="p-1">
        <ul class="mb-0 list-unstyled list-py-2 text-dark">
            ...
            <li class="position-relative">
                ...
                <span class="stretched-link" rel="tooltip" title="Maintenance Number"></span>
            </li>
            <li class="position-relative">
                <div class="gap-2 d-flex align-items-center">
                    <div class="icon-section"><i class="bi-person-bounding-box dropdown-item-icon"></i></div>
                    <div class="d-content-section">{{ $maintenanceRequest->getRequesterName() }}</div>
                </div>
                <span class="stretched-link" rel="tooltip" title="Maintenance Requester"></span>
            </li>

            @if ($maintenanceRequest->reviewer()->exists())
                <li class="position-relative">
                    <div class="gap-2 d-flex align-items-center">
                        <div class="icon-section"><i class="bi-person-badge dropdown-item-icon"></i></div>
                        <div class="d-content-section"> {!! $maintenanceRequest->getReviewer() !!} </div>
                    </div>
            ...
            <li class="position-relative">
                <div class="gap-2 d-flex align-items-center">
                    <div class="icon-section"><i class="bi-person-badge dropdown-item-icon"></i></div>
                    <div class="d-content-section"> {!! $maintenanceRequest->getApproverName() !!} </div>
                </div>
            ...
            <li class="position-relative">
                <div class="gap-2 d-flex align-items-center">
                    ...
                    <div class="d-content-section">{!! $maintenanceRequest->request_date !!} </div>
                </div>
            ...
            <li class="position-relative">
                <div class="gap-2 d-flex align-items-start">
                    ...
                    <div class="d-content-section"> {!! $maintenanceRequest->remarks !!}</div>
                </div>
