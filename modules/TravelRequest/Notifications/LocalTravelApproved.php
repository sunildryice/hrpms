...
class LocalTravelApproved extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link'=>route('local.travel.reimbursements.show', $this->localTravel->id),
            'alternate_link'=>route('local.travel.reimbursements.show', $this->localTravel->id),
            'subject'=> 'Local travel reimbursement '.$this->localTravel->getLocalTravelNumber().' has been approved.'
        ];
    }
