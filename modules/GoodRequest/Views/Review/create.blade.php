...
@section('title', 'Review Goods Request')
...
@section('page_js')
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('goodRequestReviewForm');
                    ...
                    excluded: new FormValidation.plugins.Excluded({
                        excluded: function(field, ele, eles) {
                            const statusId = parseInt(form.querySelector('[name="status_id"]')
                                .value);
                            return (field === 'approver_id' && statusId !== 11) ||
                                (field === 'status_id' && statusId === 11);
                        },
                    }),
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('review.good.requests.store', $goodRequest->id) }}"
                                  id="goodRequestReviewForm" method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
