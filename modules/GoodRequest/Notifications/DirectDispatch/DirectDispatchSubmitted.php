...
class DirectDispatchSubmitted extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link' => $url,
            'subject' => 'Direct dispatch goods request ' . $this->goodRequest->getGoodRequestNumber() . ' has been submitted for your approval/assignment.'
        ];
    }
}
