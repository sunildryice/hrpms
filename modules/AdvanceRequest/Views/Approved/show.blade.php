...
@section('title', 'Approved Advance Request Detail')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('[href="#navbarAdvanceMenuName"]').addClass('active').attr(
                'aria-expanded', 'true');
            $('#navbarVerticalMenu').find('#navbarAdvanceMenuName').addClass('show');
            $('#navbarVerticalMenu').find('#approved-advance-requests-menu').addClass('active');
                    ...
                    <div class="brd-crms flex-grow-1">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('approved.advance.requests.index') }}"
                                        class="text-decoration-none text-dark">Approved Advance
                                        Requests</a>
                                </li>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-header fw-bold">
                                Approved Advance Request Details
                            </div>
                            <div class="card-body">
                                <div class="p-1">
