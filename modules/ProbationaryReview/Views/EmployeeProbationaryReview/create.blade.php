    ...
    <div class="card">
        <div class="card-body">
            ...
            @if($authUser->can('employeeRemarks', $probationaryReview))
                <form action="{!! route('employeeProbation.review.detail.requests.store', $probationaryReview->id) !!}"
                    method="post" enctype="multipart/form-data" id="employeeProbationReviewAddForm" autocomplete="off">
                    {!! csrf_field() !!}
