...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#closed-vehicle-requests-menu').addClass('active');

            var oTable = $('#vehicleRequestTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('closed.vehicle.requests.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#vehicleRequestTable').on('click', '.close-vehicle-request', function(e) {
                e.preventDefault();
                $object = $(this);
                ...
                var confirmText = 'Close this vehicle request'
