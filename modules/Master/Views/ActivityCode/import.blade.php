...
@section('page-content')
    ...
    <div class="m-content p-3">
        ...
        <div class="container-fluid-s">
            <div class="card">
                <div class="card-body">
                    <form action="{!! route('master.activity.codes.import.store') !!}" method="post"
                          enctype="multipart/form-data" id="activityCodeImportForm" autocomplete="off">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-lg-3">
                        ...
                        <div class="card-footer border-0 justify-content-end d-flex gap-2">
                            ...
                            <a href="{!! route('master.activity.codes.index') !!}"
