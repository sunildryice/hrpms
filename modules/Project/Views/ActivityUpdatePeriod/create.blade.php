<div class="modal-header bg-primary text-white">
    <h5 class="modal-title mb-0 fs-6" id="openModalLabel">Create Activity Update Period</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    <form action="{{ route('activity-update-periods.store') }}" method="POST" id="activityUpdatePeriodCreateForm"
        autocomplete="off">
        @csrf
        <div class="row g-3">
            <div class="col-md-6">
...
<div class="modal-footer">
    ...
    <button type="submit" form="activityUpdatePeriodCreateForm" class="btn btn-primary">Save</button>
</div>
