<div class="card-header fw-bold">Add New Training</div>
<form class="needs-validation" action="{{ route('employees.trainings.store', $employee->id) }}" method="post"
      id="trainingAddForm" enctype="multipart/form-data" autocomplete="off">
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-lg-3">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control @if($errors->has('institution')) is-invalid @endif" name="institution" placeholder="Institution name"
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control @if($errors->has('training_topic')) is-invalid @endif" name="training_topic" placeholder="Training topic"
                       value="{{ old('training_topic') }}">
