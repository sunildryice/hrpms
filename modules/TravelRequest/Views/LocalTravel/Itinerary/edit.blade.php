...
<form action="{!! route('local.travel.reimbursements.itineraries.update', [
    ...
    <div class="modal-body">
                ...
                <div class="row">
                    <div class="input-group has-validation">
                        <input type="text" class="form-control" name="departure_place" autofocus=""
                            value="{!! $localTravelItinerary->departure_place !!}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="input-group has-validation">
                        <input type="text" class="form-control" name="arrival_place" autofocus=""
                            value="{!! $localTravelItinerary->arrival_place !!}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-9">
                <input type="number" class="form-control" name="total_fare"
                    value="{{ $localTravelItinerary->total_fare }}" placeholder="Fare">
            </div>
        </div>
