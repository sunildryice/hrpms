...
@section('title', 'Verify Advance Settlement Request')
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('verify.advance.settlements.index') }}"
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('verify.advance.settlements.store', $advanceSettlementRequest->id) }}"
                        id="advanceRequestReviewForm" method="post" enctype="multipart/form-data" autocomplete="off">
                        <div class="card-body">
                            <div class="c-b">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="status_id" class="select2 form-control" data-width="100%">
                                            ...
                                            <option value="{{ config('constant.RETURNED_STATUS') }}">Return to Requester
                                            </option>
                                            <option value="{{ config('constant.VERIFIED2_STATUS') }}">Verified</option>
                                        </select>
                        ...
                        <div class="card-footer border-0 justify-content-end d-flex gap-2">
                            ...
                            <a href="{!! route('verify.advance.settlements.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
