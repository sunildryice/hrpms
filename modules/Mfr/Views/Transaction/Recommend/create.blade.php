...
@section('title', 'Recommend Transaction')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#recommend-transaction').addClass('active');
        });

        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('travelClaimRecommendForm');
                    ...
                    excluded: new FormValidation.plugins.Excluded({
                        excluded: function(field, ele, eles) {
                            const statusId = parseInt(form.querySelector('[name="status_id"]')
                                .value);
                            return (field === 'approver_id' && statusId !== 4) || (field ===
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="m-0 breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('mfr.transaction.recommend.index') }}"
                                class="text-decoration-none text-dark">Recommend Transaction
                            </a>
                        </li>
    ...
    <section class="registration">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="{{ route('mfr.transaction.recommend.store', $transaction->id) }}" id="travelClaimRecommendForm"
                    ...
                    <div class="card">
                                ...
                                <div class="mb-2 row" id="recommendBlock" style="display: none;">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="approver_id" class="select2 form-control" data-width="100%">
                                            ...
                                            @foreach ($approvers as $recommendr)
                                                <option value="{{ $recommendr->id }}">
                                                    {{ $recommendr->getFullName() }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="gap-2 card-footer border-top justify-content-end d-flex">
                            ...
                            <a href="{!! route('mfr.transaction.recommend.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
