...
@section('title', 'Approve Annual Performance Review')

@section('page_js')
    <script type="text/javascript">
        $(function() {
            $('#navbarVerticalMenu').find('#performance-approve-index').addClass('active');
...
@section('page-content')
    ...
    <section>
        <div class="card">
            ...
            <form action="{{ route('performance.approve.store') }}" id="performanceReviewProcessForm" method="post"
                ...
                <div class="gap-2 border-0 card-footer justify-content-end d-flex">
                    ...
                    <a href="{!! route('performance.approve.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                </div>
            </form>
        </div>
    </section>
