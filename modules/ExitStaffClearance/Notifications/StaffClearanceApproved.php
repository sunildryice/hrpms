...
class StaffClearanceApproved extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'link' => route('staff.clearance.show', $this->staffClearance->id),
            'alternate_link' => route('staff.clearance.index', $this->staffClearance->id),
            'subject' => 'Exit Staff Clearance for '.$this->staffClearance->employee->getFullName().' has been approved',
        ];
    }
}
