                            ...
                            <select class="form-control" name="review_type_id" id="review_type_id">
                                ...
                                @foreach ($reviewTypes as $reviewType)
                                    <option value="{{ $reviewType->id }}"
                                        {{ $reviewType->id == old('review_type_id') ? 'selected' : '' }}>
                                        {{ $reviewType->title }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-2" id="external_reviewer_row" style="display: none;">
                        ...
                        <div class="col-lg-3">
                            <select class="select2 form-control" name="external_reviewer_id" id="external_reviewer_id">
                                <option value="" selected disabled>Select External Reviewer</option>
                                @foreach ($employees as $employee)
                                    @if ($employee->user)
                                        <option value="{{ $employee->user->id }}"
                                            {{ old('external_reviewer_id') == $employee->user->id ? 'selected' : '' }}>
                            ...
                            @if ($errors->has('external_reviewer_id'))
                                <div class="fv-plugins-message-container invalid-feedback">
                                    <div data-field="external_reviewer_id">
                                        {!! $errors->first('external_reviewer_id') !!}
                                    </div>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-3">
                            <input type="text" class="form-control @if ($errors->has('deadline_date')) is-invalid @endif"
                                name="deadline_date" id="deadline_date" value="{{ old('deadline_date') }}"
                                autocomplete="off">
