        ...
        <section class="registration">
            ...
            <div class="row">
                                ...
                                <ul class="list-unstyled list-py-2 text-dark mb-0">
                                    <li class="pb-2"><span class="card-subtitle text-uppercase text-primary">About</span></li>
                                        ...
                                        <div class="d-flex gap-2 align-items-center">
                                            <div class="icon-section"> <i class="bi-wrench-adjustable dropdown-item-icon"></i></div>
                ...
                <div class="col-lg-9">
                    ...
                    <form action="http://127.0.0.1:8000/reponses/training/1/request" method="post" enctype="multipart/form-data"
                        id="trainingDetailAddForm" autocomplete="off" class="fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mb-2 fv-plugins-icon-container">
                                    <div class="col-lg-12">
                                        <label for="qone" class="form-label required-label">1. Is training the appropriate solution? Hint:
                                            The
                                            problem must be caused by a skill/knowledge deficiency.
                                        </label>
                                        <textarea name="textarea[9]" id="qone" cols="30" rows="5" class="form-control question fv-plugins-icon-input"></textarea><i data-field="textarea" class="fv-plugins-icon"></i>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="row mb-2 fv-plugins-icon-container">
                                    <div class="col-lg-12">
                                        <label for="qone" class="form-label required-label">Is the request aligned with our current
                                            organizational objectives and priorities?
                                        </label>
                                        <textarea name="textarea[10]" id="qone" cols="30" rows="5" class="form-control question fv-plugins-icon-input"></textarea><i data-field="textarea" class="fv-plugins-icon"></i>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="row mb-2 fv-plugins-icon-container">
                                    <div class="col-lg-12">
                                        <label for="qone" class="form-label required-label">Are resources available to meet the request?
                                        </label>
                                        <textarea name="textarea[11]" id="qone" cols="30" rows="5" class="form-control question fv-plugins-icon-input"></textarea><i data-field="textarea" class="fv-plugins-icon"></i>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mt-2">
                                            <select name="reviewer_id" class="select2 form-control select2-hidden-accessible"
                                                data-width="100%" data-select2-id="select2-data-1-4wsy" tabindex="-1"
                                                aria-hidden="true">
                                                <option value="" data-select2-id="select2-data-3-3ej1">Select a Reviewer</option>
                                                <option value="15">
                                                    archana awale
                                                </option>
                                                <option value="12">
                                                ...
                                                data-select2-id="select2-data-2-wdfn" style="width: 100%;"><span
                                                    class="selection"><span
                                                        class="select2-selection select2-selection--single" role="combobox"
                                                        aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                        aria-disabled="false" aria-labelledby="select2-reviewer_id-qm-container"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-12">
                                ...
                                <label for="qone" class="form-label required-label">Why do you think/feel you need this training?
                                </label>
