...
@section('title', __('label.districts'))

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#districts-menu').addClass('active');

            var oTable = $('#districtTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.districts.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $(document).on('click', '.open-district-modal-form', function(e) {
                e.preventDefault();
                        ...
                        <table class="table" id="districtTable">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('label.enabled') }}?</th>
