...
@section('title', 'Approve Leave Encash Request')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approve-leave-encash-menu').addClass('active');
        });

        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('leaveEncashApproveForm');
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            ...
                            <form action="{{ route('approve.leave.encash.store', $leaveEncash->id) }}"
                                id="leaveEncashApproveForm" method="post" enctype="multipart/form-data" autocomplete="off">
                                            ...
                                            <div class="row mb-2" id="recommendBlock" style="display: none;">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="recommended_to" class="select2 form-control"
                                                        ...
                                                        @if ($leaveEncash->requester->employee->latestTenure->supervisor_id == auth()->user()->employee_id)
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                    ...
                                    <a href="{!! route('approve.leave.requests.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
