                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tbody id="actionRemarkTableBody">
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" name="action_points[]" placeholder="Enter action point">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" name="remarks[]" placeholder="Enter remark">
                                                </td>
