            ...
            <div class="col-lg-8">
                ...
                <div class="print-header-info mb-3">
                    <ul class="list-unstyled m-0 p-0 fs-7">
                        ...
                        <li><span class="fw-bold me-2">Bank A/C No. : </span><span>{{$paymentSheet->supplier->account_number}}</span></li>
                        <li><span class="fw-bold me-2">Bank and Branch :</span><span>{{$paymentSheet->supplier->bank_name.', '.$paymentSheet->supplier->branch_name}}</span></li>
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column justify-content-end">
                    ...
                    <ul class="list-unstyled m-0 p-0 fs-7 align-self-end">
                        ...
                        @php
                            $purchaseOrderNumbers = $paymentSheet->purchaseOrders->map(function($purchaseOrder) {
                                return $purchaseOrder->getPurchaseOrderNumber();
                            })->join(', ');
                        @endphp
                        <li><span class="fw-bold me-2">Purchase Order NO.</span><span>{{ $purchaseOrderNumbers }}</span></li>
