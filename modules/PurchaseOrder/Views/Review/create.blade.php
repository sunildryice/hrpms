...
@section('title', 'Review Purchase Order')
...
@section('page_js')
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            const form = document.getElementById('purchaseOrderReviewForm');
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('review.purchase.orders.store', $purchaseOrder->id) }}"
                                  id="purchaseOrderReviewForm" method="post"
