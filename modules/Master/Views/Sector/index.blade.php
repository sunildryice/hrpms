...
@section('page_js')
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function(e) {
            $('#navbarVerticalMenu').find('#sectors-menu').addClass('active');

            var oTable = $('#sectorTable').DataTable({
                scrollX: true,
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.sectors.index') }}",
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
            ...
            $('#sectorTable').on('click', '.delete-record', function(e) {
                e.preventDefault();
                $object = $(this);
        ...
        <div class="pb-3 mb-3 border-bottom">
            ...
            <div class="brd-crms flex-grow-1">
                ...
                <div class="add-info justify-content-end">
                    <button data-toggle="modal" class="btn btn-primary btn-sm open-sector-modal-form"
                        href="{!! route('master.sectors.create') !!}">
