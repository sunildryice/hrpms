...
class LieuLeaveRequestApproved extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'subject' => 'Lieu leave request ' . $this->lieuLeaveRequest->id . ' has been approved. Requester : ' . $this->lieuLeaveRequest->requester->full_name,
        ];
    }
}
