    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            ...
            $('.step-item').click(function() {
                ...
                localStorage.setItem('edit-tab', $selectedTab);
        ...
        function displayTenureEditForm($object, url) {
            ...
            var successCallback = function(response) {
                ...
                $('#editTenureBlock').find('[name="to_date"]').val(response.to_date);
        ...
        function displayHourEditForm($object, url) {
            $element = $(this);
            var successCallback = function(response) {
                console.log(response);
                $('#addHourBlock').hide();
                $('#editHourBlock').show();
                $('#editHourBlock').find('[name="start_date"]').val(response.start_date);
                $('#editHourBlock').find('[name="end_date"]').val(response.end_date);
                $('#editHourBlock').find('[name="work_percentile"]').val(response.hour.work_percentile);
                $('#editHourBlock').find('[name="remarks"]').val(response.hour.remarks);

                $('#editHourBlock').find('form').attr('action', response.updateAction);
            }
            var errorCallback = function(error) {
                console.log(error);
            }
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="add-info justify-content-end">
                <div class="py-3 mb-2 rounded text-end">
                    @can('manage-employee')
                        <a href="{{ route('employees.profile', $employee->id) }}" class="btn btn-sm btn-primary"
                            style=" text-decoration: none"> <i class="bi bi-person me-1"></i> Profile</a>
                    @endcan
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="c-tabs-content" id="family-details">
                    <div class="mb-5 card" id="addFamilyMemberBlock">
                        @include('Employee::FamilyDetail.create')
                    </div>
                    <div class="mb-5 card" id="editFamilyMemberBlock" style="display: none;">
                ...
                @if ($authUser->can('manage-tenure'))
                    <div class="c-tabs-content" id="tenure-details">
                        <div class="mb-5 card" id="addTenureBlock">
                            @include('Employee::Tenure.create')
                        </div>
                        @if ($employee->tenures->count())
                            <div class="mb-5 card" id="editTenureBlock" style="display: none;">
                    ...
                    <div class="c-tabs-content" id="hour-details">
                        <div class="mb-5 card" id="addHourBlock">
                            @include('Employee::Hour.create')
                        </div>
                        @if ($employee->hours->count())
                            <div class="mb-5 card" id="editHourBlock" style="display: none;">
                                @include('Employee::Hour.edit')
                            </div>
                            <div class="mb-5 card">
                                @include('Employee::Hour.index')
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="c-tabs-content" id="insurance-details">
                        <div class="mb-5 card" id="addInsuranceBlock">
                            @include('Employee::Insurance.create')
                        </div>
                        <div class="mb-5 card" id="editInsuranceBlock" style="display: none;">
                ...
                <div class="c-tabs-content" id="education-details">
                    <div class="mb-5 card" id="addEducationBlock">
                        @include('Employee::Education.create')
                    </div>
                    <div class="mb-5 card" id="editEducationBlock" style="display: none;">
                ...
                <div class="c-tabs-content" id="experience-details">
                    <div class="mb-5 card" id="addExperienceBlock">
                        @include('Employee::Experience.create')
                    </div>
                    <div class="mb-5 card" id="editExperienceBlock" style="display: none;">
                ...
                <div class="c-tabs-content" id="training-details">
                    <div class="mb-5 card" id="addTrainingBlock">
                        @include('Employee::Training.create')
                    </div>
                    <div class="mb-5 card" id="editTrainingBlock" style="display: none;">
