...
@section('page_js')
    <script type="text/javascript">
        ...
        var oTable = $('#trainingApproveTable').DataTable({
                scrollX: true,
            processing: true,
            serverSide: true,
            ajax: "{{ route('approve.training.requests.index') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Training Request Approve</li>
                        </ol>
                    </nav>
                    <h4 class="m-0 lh1 mt-1 fs-6 text-uppercase fw-bold text-primary">Training Request Approve</h4>
                </div>
            </div>
            ...
            <div class="card" id="training-request-table">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderedless" id="trainingApproveTable">
