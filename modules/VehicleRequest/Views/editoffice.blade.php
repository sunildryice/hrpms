            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="rounded border shadow-sm vertical-navigation pt-3 pb-3">
                        <ul class="m-0 list-unstyled v-mneu">
                            <li class="nav-item">
                                <a href="#" class="nav-link step-item  text-decoration-none active" data-tag="office-vehicle">
                ...
                <div class="col-lg-9">
                    <div class="card shadow-sm border rounded c-tabs-content active" id="office-vehicle">
                        ...
                        <form action="{{ route('vehicle.requests.update', $vehicleRequest->id) }}" id="officeVehicleRequestEditForm"
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <select name="office_id"
                                            ...
                                            @foreach($offices as $office)
                                                <option @if($selectedOfficeId == $office->id) selected
                                                        @endif
                                        ...
                                        <select class="form-control select2 @if($errors->has('vehicle_type_id')) is-invalid @endif"
                                            ...
                                            @foreach($vehicleTypes as $vehicleType)
                                                <option value="{{ $vehicleType->id }}"
                                                        @if($selectedVehicleTypeId == $vehicleType->id) selected @endif>{{ $vehicleType->title }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="input-group has-validation">
                                                    ...
                                                    value="{!! old('office_start_datetime') ?old('office_start_datetime'): $vehicleRequest->start_datetime->format('YYYY-mm-dd H:i') !!}"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input data-toggle="datepicker-time2" type="text" name="office_end_datetime"
                                                    value="{!! old('office_end_datetime') ? old('office_end_datetime') : $vehicleRequest->end_datetime->format('Y-m-d H:i') !!}"
