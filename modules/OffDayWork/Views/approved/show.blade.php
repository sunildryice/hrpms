...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#approved-off-day-work-approve').addClass('active');
        });
    </script>
@endsection
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('approved.off.day.work.index') }}" class="text-decoration-none text-dark">
                                Approved Off Day Work Requests
                            </a>
                        </li>
