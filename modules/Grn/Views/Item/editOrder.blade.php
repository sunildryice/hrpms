<div class="text-white modal-header bg-primary">
    <h5 class="mb-0 modal-title fs-6" id="openModalLabel">Edit GRN Item</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form action="{!! route('grns.items.from.order.update', [$grnItem->grn_id, $grnItem->id]) !!}" method="post" enctype="multipart/form-data" id="grnItemForm" autocomplete="off">
    <div class="modal-body">
        ...
        <div class="mb-2 row">
            <div class="col-lg-3">
                <div class="d-flex align-items-start h-100">
                    <label for="" class="m-0">{{ __('label.unit-price') }}</label>
                </div>
            </div>
            <div class="col-lg-9">
                <input type="number" name="unit_price" class="form-control" readonly
                    value="{{ $grnItem->grnitemable->unit_price }}">
            </div>
        </div>
        ...
        <div class="mb-2 row">
            <div class="col-lg-3">
                <div class="d-flex align-items-start h-100">
                    <label for="" class="m-0">{{ __('label.quantity-ordered') }}</label>
                </div>
            </div>
            <div class="col-lg-9">
        ...
        <div class="mb-2 row">
            ...
            <div class="col-lg-9">
                <input type="number" class="form-control" name="discount_amount"
                    value="{{ $grnItem->discount_amount }}" placeholder="Discount (If Any)">
            </div>
        </div>
        <div class="mb-2 row">
            <div class="col-lg-3">
