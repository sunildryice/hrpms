...
@section('title', 'Approve Travel Request Cancellation')
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('approve.ta.requests.index') }}"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="border-top pt-4">
                        <form action="{{ route('approve.ta.requests.cancel.store', $travel->id) }}"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="status_id" class="select2 form-control" data-width="100%">
                                            ...
                                            <option value="{{config('constant.CANCELLED_STATUS')}}" @if (old('status_id') == config('constant.CANCELLED_STATUS')) selected @endif>
                                                Cancel
                                            </option>
                                        </select>
