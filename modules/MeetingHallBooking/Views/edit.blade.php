...
@section('page_js')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function (e) {
            const form = document.getElementById('hallBookingEditForm');
...
@section('page-content')
            ...
            <section class="registration">
                <div class="card">
                    <div class="card-header fw-bold">Meeting Hall Booking</div>
                    <form action="{{ route('meeting.hall.bookings.update', $meetingHallBooking->id) }}" id="hallBookingEditForm" method="post"
                          enctype="multipart/form-data" autocomplete="off">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-center h-100 required-label">
                                        <label for="validationProject" class="m-0">Meeting Hall
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <select name="meeting_hall_id" class="select2 form-control
                                        ...
                                        @foreach($meetingHalls as $meetingHall)
                                            <option value="{{ $meetingHall->id }}" {{$meetingHall->id == $meetingHallBooking->meeting_hall_id? "selected":""}}>{{ $meetingHall->title }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-center h-100 required-label">
                                        <label for="validationtraveltype" class="m-0">Meeting Date
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control
                                        @if($errors->has('meeting_date')) is-invalid @endif"
                                           name="meeting_date" value="{{ $meetingHallBooking->meeting_date->format('Y-m-d') }}"/>
                                    @if($errors->has('meeting_date'))
                                        <div class="fv-plugins-message-container invalid-feedback">
                                            <div
                                                data-field="meeting_date">{!! $errors->first('meeting_date') !!}</div>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-center h-100 required-label">
                                        <label for="validationstarttime" class="m-0">Start Time
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control
                                        @if($errors->has('start_time')) is-invalid @endif"
                                           name="start_time" value="{{ $meetingHallBooking->start_time }}" readonly/>
                                    @if($errors->has('start_time'))
                                        <div class="fv-plugins-message-container invalid-feedback">
                                            <div
                                                data-field="start_time">{!! $errors->first('start_time') !!}</div>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-center h-100 required-label">
                                        <label for="validationendtime" class="m-0">End time
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control
                                        @if($errors->has('end_time')) is-invalid @endif"
                                           name="end_time" value="{{ $meetingHallBooking->end_time }}" readonly/>
                                        @if($errors->has('end_time'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div
                                                    data-field="end_time">{!! $errors->first('end_time') !!}</div>
                                            </div>
                                        @endif
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-center h-100 required-label">
                                        <label for="validationPurpose" class="m-0">Purpose </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <input type="text"
                                           ...
                                           name="purpose"
                                           value="{{ $meetingHallBooking->purpose }}"
                                           placeholder="Purpose of Meeting">
                                    @if($errors->has('purpose'))
                                        <div class="fv-plugins-message-container invalid-feedback">
                                            <div
                                                data-field="purpose">{!! $errors->first('purpose') !!}
                                            </div>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-center h-100 required-label">
                                        <label for="" class="m-0">No. of Attendees </label>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <input type="number"
                                           ...
                                           value="{{$meetingHallBooking->number_of_attendees }}"
                                           min="2">
                                    @if($errors->has('number_of_attendees'))
                                        <div class="fv-plugins-message-container invalid-feedback">
                                            <div
                                                data-field="number_of_attendees">{!! $errors->first('number_of_attendees') !!}
                                            </div>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-9">
                                    <textarea type="text"
                                           ...
                                           name="remarks">@if($meetingHallBooking->remarks){{$meetingHallBooking->remarks }}@endif</textarea>
                        ...
                        <div class="card-footer border-0 justify-content-end d-flex gap-2">
                            <button type="submit" name="btn" value="update" class="btn btn-primary btn-sm">Update</button>
                            <button type="submit" name="btn" value="submit" class="btn btn-primary btn-sm">Book</button>
