...
class ReconcileConsultantLeave extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dryice:reconcile:consultant:leave {consultant}';
     ...
     * @var string
     */
    protected $description = 'Update consultant master leave for a selected consultant.';
    ...
    {
        $steCode = $this->argument('consultant');
        $employee = $this->employees->findByField('ste_code', $steCode);
        ...
        if($employee->user) {
            ...
            $this->info('Leave records of ' . $employee->getFullName() . ' are not updated. User is not assigned for this STE.');
        }
    }
}
