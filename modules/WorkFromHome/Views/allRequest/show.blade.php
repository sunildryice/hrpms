...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#wfh-requests-all-index').addClass('active');
        });
    </script>
@endsection
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('wfh.requests.all') }}"
                                class="text-decoration-none text-dark">All Requests</a></li>
