...
@section('page_js')
    <script type="text/javascript">
        $(document).ready(function () {
            $('#navbarVerticalMenu').find('[href="#navbarPurchaseOrder"]').addClass('active').attr('aria-expanded', 'true');
            $('#navbarVerticalMenu').find('#navbarPurchaseOrder').addClass('show');
            $('#navbarVerticalMenu').find('#approve-purchase-orders-menu').addClass('active');
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('approve.purchase.orders.store', $purchaseOrder->id) }}"
