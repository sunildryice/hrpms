...
@section('title', 'Review Employee Requisition')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#review-employee-requests-menu').addClass('active');
        });

        document.addEventListener('DOMContentLoaded', function(e) {
            const form = document.getElementById('employeeRequestReviewForm');
...
@section('page-content')
            ...
            <div class="brd-crms flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('review.employee.requests.index') }}"
    ...
    <section class="registration">
        ...
        <div class="card">
            ...
            <form action="{{ route('review.employee.requests.store', $employeeRequest->id) }}"
                id="employeeRequestReviewForm" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="card-body">
                    <div class="c-b">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control"
                                    value="{{ $employeeRequest->approver->getFullName() }}" readonly>
                            </div>
                        </div>
                ...
                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                    ...
                    <a href="{!! route('review.employee.requests.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                </div>
            </form>
        </div>
    </section>
