<header class="border-bottom d-flex align-items-center w-100 p-3 pe-3 bg-white hidden-print">
    ...
    <div class="d-flex justify-content-end flex-grow-1">
        <ul class="list-unstyled list-inline m-0">
            ...
            <li class="list-inline-item i-noftif {{ !empty($notificationCount) ? 'has-notification' : '' }}">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end is-notification m-0 p-0 border-0 shadow-sm"
                        ...
                        @endforeach
                        <li class="text-center p-1"><a class="text-decoration-none fs-7 text-dark"
            ...
            <li class="list-inline-item">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item fs-7" href="{{ route('auth.logout') }}"><i class="bi-power"></i>
                                Logout</a></li>
                    </ul>
                </div>
