...
@section('title', 'Approve Fund Request Cancellation')

@section('page_js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#navbarVerticalMenu').find('#cancel-fund-requests-menu').addClass('active');
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="mt-2 rounded border shadow-sm card">
                            ...
                            <form action="{{ route('approve.fund.requests.cancel.store', $fundRequest->id) }}"
                                id="fundRequestApproveForm" method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="status_id" class="select2 form-control" data-width="100%">
                                                        ...
                                                        <option value="{{ config('constant.APPROVED_STATUS') }}">Reject
                                                            Cancel Request</option>
                                                        <option value="{{ config('constant.CANCELLED_STATUS') }}">Cancel
                                                        </option>
                                                    </select>
                                ...
                                <div class="gap-2 border-0 card-footer justify-content-end d-flex">
                                    ...
                                    <a href="{!! route('approve.fund.requests.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
