    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var oTable = $('#paymentSheetTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('payment.sheets.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#paymentSheetTable').on('click', '.delete-record', function(e) {
                e.preventDefault();
                $object = $(this);
            ...
            $('#paymentSheetTable').on('click', '.amend-record', function(e) {
                e.preventDefault();
                ...
                ajaxTextSweetAlert(url, 'POST', `Amend ${number}?`, 'Remarks', 'log_remarks',successCallback );
            })
        });
    </script>
@endsection
        ...
        <div class="pb-3 mb-3 border-bottom">
            ...
            <div class="brd-crms flex-grow-1">
                ...
                <div class="add-info justify-content-end">
                    <a href="{{ route('payment.sheets.create') }}" class="btn btn-primary btn-sm">
                        <i class="bi-plus"></i> New Payment Sheet
                    </a>
                </div>
            </div>
        </div>
