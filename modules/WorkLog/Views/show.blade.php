                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a href="{!! route('monthly.work.logs.index') !!}" class="text-decoration-none text-dark">Worklog</a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">
                ...
                <div class="table-responsive table-container">
                    <table class="table table-borderedless" id="workPlanDailyLogTable">
                        <thead class="bg-light sticky-top">
                            <tr>
                                <th style="width: 100px;" class="sticky-col first-col" style="position: sticky; top: 0">{{ __('label.date') }}</th>
