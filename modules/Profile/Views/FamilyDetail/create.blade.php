    ...
    <div class="card-body">
        ...
        <div style="display: none" id="emergencyContactBlock">
            <div class="row mb-2">
                <div class="col-lg-3">
                    <div class="d-flex align-items-start h-100">
                        <label for="validationProvince" class="form-label required-label">Province
                        </label>
                    </div>
                </div>
                <div class="col-lg-9">
            ...
            <div class="row mb-2">
                <div class="col-lg-3">
                    <div class="d-flex align-items-start h-100">
                        <label for="validationMunicipality" class="form-label required-label">Local Level
                        </label>
                    </div>
                </div>
                <div class="col-lg-9">
            ...
            <div class="row mb-2">
                <div class="col-lg-3">
                    <div class="d-flex align-items-start h-100">
                        <label for="validationWardNumber" class="form-label required-label">Ward Number
                        </label>
                    </div>
                </div>
                <div class="col-lg-9">
                            ...
                            callback: {
                                ...
                                callback: function (value, validator, $field) {
                                    if ($('[name="emergency_contact"]').is(':checked')) {
                                        ...
                                        validator.updateStatus('local_level_id', validator.STATUS_VALID);
                                        return true;
                                    }
                                }
                            },
                            ...
                            callback: {
                                ...
                                callback: function (value, validator, $field) {
                                    if ($('[name="emergency_contact"]').is(':checked')) {
                                        ...
                                        validator.updateStatus('contact_number', validator.STATUS_VALID);
                                        return true;
                                    }
                                }
                            },
