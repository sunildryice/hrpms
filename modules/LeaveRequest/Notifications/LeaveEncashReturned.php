...
class LeaveEncashReturned extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'link' => route('leave.encash.edit', $this->leaveEncash->id),
            'subject' => 'Leave encash request ' . $this->leaveEncash->getEncashNumber() . ' has been returned',
        ];
    }
}
