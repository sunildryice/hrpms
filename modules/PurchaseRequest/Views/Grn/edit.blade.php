    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function(e) {
            ...
            $('.received_date').datepicker({
                ...
                autoHide: true,
                format: 'yyyy-mm-dd',
                startDate: '{{ $grn->received_date->format('Y-m-d') }}',
                endDate: '{{ date('Y-m-d') }}',
            }).on('change', function() {
        ...
        <div class="container-fluid">
            ...
            <section class="registration">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <form action="{{ route('grns.update', $grn->id) }}" id="grnEditForm" method="post"
                                enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-lg-3">
                                            <div class="d-flex align-items-start h-100">
                                                <label for="validationSupplier" class="form-label required-label">Received
                                                    Date</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-lg-3">
                                            <div class="d-flex align-items-start h-100">
                                                <label for="validationSupplier" class="m-0">Supplier</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                            <select class="form-control select2" name="supplier_id">
                                                ...
                                                @foreach ($suppliers as $supplier)
                                                    <option value="{!! $supplier->id !!}"
                                                        @if ($supplier->id == $grn->supplier_id) selected @endif>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea class="form-control" name="received_note" rows="3">{!! old('received_note') ?: $grn->received_note !!}</textarea>
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        <div class="card-header fw-bold">
                                                ...
                                                <span>  Items</span>
                                           <a class="btn btn-primary btn-sm text-capitalize" href="{!! route('approved.purchase.requests.grns.addItem', [$purchaseRequest->id,$grn->id]) !!}">
                                ...
                                <div class="card-footer border-0 justify-content-end d-flex gap-2">
                                    ...
                                    <a href="{!! route('grns.index') !!}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
