...
class ExitAssetHandoverLog extends Model
{
     ...
     * @var string
     */
    protected $table = 'exit_asset_handover_logs';
    ...
    {
        return $this->belongsTo(ExitAssetHandover::class, 'exit_asset_handover_id');
    }
